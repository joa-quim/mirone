...
# HDF5
cp /usr/local/opt/hdf5/lib/*.10.dylib .
chmod +w *.dylib
...
install_name_tool -change /usr/local/opt/szip/lib/libsz.2.dylib libsz.dylib libhdf5_hide.dylib

install_name_tool -change /usr/local/Cellar/hdf5/1.8.16_1/lib/libhdf5.10.dylib libhdf5_hide.dylib libhdf5_hl.10.dylib
mv libhdf5_hl.10.dylib libhdf5_hl_hide.dylib
install_name_tool -change /usr/local/opt/szip/lib/libsz.2.dylib libsz.dylib libhdf5_hl_hide.dylib
...
install_name_tool -change /usr/local/opt/hdf5/lib/libhdf5.10.dylib libhdf5_hide.dylib         libnetcdf.7.dylib
install_name_tool -change /usr/local/opt/hdf5/lib/libhdf5_hl.10.dylib libhdf5_hl_hide.dylib   libnetcdf.7.dylib
mv libnetcdf.7.dylib libnetcdf_hide.dylib
install_name_tool -change /usr/local/opt/szip/lib/libsz.2.dylib libsz.dylib libnetcdf_hide.dylib
...
install_name_tool -change /usr/local/Cellar/geos/3.5.0/lib/libgeos-3.5.0.dylib libgeos-3.dylib libgeos_c.1.dylib
...
install_name_tool -change /usr/local/opt/xerces-c/lib/libxerces-c-3.1.dylib libxerces-c-3.1.dylib libxerces-c.dylib 
...
install_name_tool -change /usr/local/opt/geos/lib/libgeos_c.1.dylib     libgeos_c_hide.dylib         libgdal.1.dylib
install_name_tool -change /usr/local/opt/webp/lib/libwebp.6.dylib       libwebp.dylib           libgdal.1.dylib
...
install_name_tool -change /usr/local/opt/netcdf/lib/libnetcdf.7.dylib     libnetcdf_hide.dylib    libgdal.1.dylib
install_name_tool -change /usr/local/opt/hdf5/lib/libhdf5.10.dylib      libhdf5_hide.dylib      libgdal.1.dylib
...
install_name_tool -change /usr/local/opt/libpng/lib/libpng16.16.dylib     libpng16.dylib          libgdal.1.dylib
...
install_name_tool -change /usr/local/opt/libdap/lib/libdap.21.dylib       libdap.dylib            libgdal.1.dylib
install_name_tool -change /usr/local/opt/libdap/lib/libdapserver.7.dylib  libdapserver.dylib      libgdal.1.dylib
install_name_tool -change /usr/local/opt/libdap/lib/libdapclient.6.dylib  libdapclient.dylib      libgdal.1.dylib
install_name_tool -change /usr/local/opt/libspatialite/lib/libspatialite.7.dylib libspatialite.dylib     libgdal.1.dylib
install_name_tool -change /usr/local/opt/sqlite/lib/libsqlite3.0.dylib libsqlite3.dylib libgdal.1.dylib
install_name_tool -change /usr/local/opt/pcre/lib/libpcre.1.dylib       libpcre.dylib           libgdal.1.dylib
install_name_tool -change /usr/local/opt/libxml2/lib/libxml2.2.dylib libxml2.dylib     libgdal.1.dylib
install_name_tool -change /usr/local/opt/xerces-c/lib/libxerces-c-3.1.dylib libxerces-c_hide.dylib   libgdal.1.dylib
install_name_tool -change /usr/local/opt/unixodbc/lib/libodbc.2.dylib libodbc.dylib             libgdal.1.dylib
install_name_tool -change /usr/local/opt/unixodbc/lib/libodbcinst.2.dylib libodbcinst.dylib     libgdal.1.dylib
...
install_name_tool -change /usr/local/opt/netcdf/lib/libnetcdf.7.dylib      libnetcdf_hide.dylib     libgmt.5.dylib
install_name_tool -change /usr/local/opt/pcre/lib/libpcre.1.dylib        libpcre.dylib            libgmt.5.dylib
install_name_tool -change /usr/local/opt/gdal/lib/libgdal.1.dylib        libgdal.dylib            libgmt.5.dylib
...
install_name_tool -change /usr/local/opt/netcdf/lib/libnetcdf.7.dylib      libnetcdf_hide.dylib     supplements.dylib 
install_name_tool -change /usr/local/opt/gdal/lib/libgdal.1.dylib           libgdal.dylib            supplements.dylib
install_name_tool -change /usr/local/opt/pcre/lib/libpcre.1.dylib          libpcre.dylib            supplements.dylib 
