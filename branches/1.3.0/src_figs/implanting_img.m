...
implanting_img_LayoutFcn(hObject,handles);
handles = guihandles(hObject);
...
handles.h_txtBgImgSize = findobj(hObject,'Tag','text_txtBgImgSize');% Get this text handle
handles.h_BGsize = findobj(hObject,'Tag','text_BGsize');            % Get this text handle
...
out = implanting_img_OutputFcn(hObject, [], handles);
varargout{1} = out;

% --- Outputs from this function are returned to the command line.
function varargout = implanting_img_OutputFcn(hObject, eventdata, handles)
...
function implanting_img_LayoutFcn(h1,handles);
...
h7 = axes('Parent',h1,'Units','pixels',...
'CameraPosition',[0.5 0.5 9.16025403784439],...
'Color',get(0,'defaultaxesColor'),...
'ColorOrder',get(0,'defaultaxesColorOrder'),...
...
h15 = uicontrol('Parent',h1,'FontSize',9,...
'HorizontalAlignment','left',...
'Position',[10 10 197 16],...
'String','New background image size will be:',...
'Style','text',...
'Tag','text_txtBgImgSize');

h16 = uicontrol('Parent',h1,'FontSize',9,...
'HorizontalAlignment','left',...
