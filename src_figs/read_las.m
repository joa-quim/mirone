...
'Call',{@read_las_uiCB,h1,'edit_LASfile_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
...
'Call',{@read_las_uiCB,h1,'push_LASfile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
'Tag','push_LASfile');
...
'Call',{@read_las_uiCB,h1,'push_getClass_CB'},...
...
'Call',{@read_las_uiCB,h1,'radio_colorDepth_CB'},...
'String','Depth',...
'Style','radiobutton',...
'Value',1,...
...
'Call',{@read_las_uiCB,h1,'radio_colorClass_CB'},...
...
'Call',{@read_las_uiCB,h1,'radio_colorID_CB'},...
'String','Source ID',...
'Style','radiobutton',...
'Tag','radio_colorID');

uicontrol('Parent',h1, 'Position',[20 215 90 21],...
'Call',{@read_las_uiCB,h1,'check_clipClass_CB'},...
'String','Classification',...
'Style','checkbox',...
...
'Call',{@read_las_uiCB,h1,'check_clipIntens_CB'},...
'String','Intensity',...
'Style','checkbox',...
...
'Call',{@read_las_uiCB,h1,'check_clipID_CB'},...
'String','Source ID',...
'Style','checkbox',...
'Tag','check_clipID');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_clipID'},...
'Style','edit',...
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_x_min_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
'Tag','edit_x_min');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
'Tag','edit_x_max');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
'Tag','edit_y_min');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
'Tag','edit_y_max');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_z_min_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
'Tag','edit_z_min');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_z_max_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
'Tag','edit_z_max');
...
'BackgroundColor',[1 1 1],...
'Call',{@read_las_uiCB,h1,'edit_FLEDERfile_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
...
'Call',{@read_las_uiCB,h1,'push_FLEDERfile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
'Tag','push_FLEDERfile');
...
'Call',{@read_las_uiCB,h1,'push_BINfile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
'Tag','push_BINfile');
...
'Call',{@read_las_uiCB,h1,'push_grdTool_CB'},...
'String','Call Gridding Tool',...
'Tag','push_grdTool',...
'Visible','off');

uicontrol('Parent',h1, 'Position',[230 4 181 21],...
'Call',{@read_las_uiCB,h1,'push_goFleder_CB'},...
...
function read_las_uiCB(hObject, eventdata, h1, callback_name)
