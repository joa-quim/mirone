...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'radio_origCoord_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'radio_equiCoord_CB'},...
'Position',[74 2 90 15],...
'String','Equispaced',...
'Style','radiobutton',...
...
'Callback',{@main_uiCB,h1,'edit_SmoothParam_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_Xstart_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_Xstep_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_Xend_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_Apply_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_applyNreturn_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
