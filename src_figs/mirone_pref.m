...
uicontrol('Parent',h1,'Position',[20 293 79 15],...
...
uicontrol('Parent',h1,'Position',[20 274 79 15],...
...
uicontrol('Parent',h1,'Position',[174 300 91 15],...
'HorizontalAlignment','left',...
'String','Grid max size (Mb)',...
'Style','text',...
'UserData','general');

uicontrol('Parent',h1,'Position',[174 275 71 15],...
'HorizontalAlignment','left',...
'String','Swath ratio',...
'Style','text',...
'UserData','general');
...
uicontrol('Parent',h1,'Position',[10 140 180 15],...
...
uicontrol('Parent',h1,'Position',[10 188 80 15],...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'Position',[145 63 86 15],...
'HorizontalAlignment','left',...
'String','Default line color',...
'Style','text',...
'UserData','general');

uicontrol('Parent',h1,'Position',[10 240 80 15],...
'HorizontalAlignment','left',...
'String','Measure unites',...
'Style','text',...
'UserData','general');

uicontrol('Parent',h1,'Position',[121 240 90 15],...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'Position',[28 240 91 15],...
...
uicontrol('Parent',h1,'Position',[146 240 101 15],...
...
uicontrol('Parent',h1,'Position',[28 146 126 15],...
...
uicontrol('Parent',h1,'Position',[28 116 126 15],...
...
uicontrol('Parent',h1,'Position',[28 86 126 15],...
...
uicontrol('Parent',h1,'Position',[28 170 211 20],...
...
uicontrol('Parent',h1,'Position',[27 268 211 20],...
'FontAngle','italic','FontSize',12,...
'FontWeight','demi',...
'HorizontalAlignment','left',...
