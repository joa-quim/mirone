...
% Helper window to select some important defaults
...
% $Id: mirone_pref.m 10232 2018-01-26 01:45:05Z j $
	...
	if (strcmp(handles.TDRver, '2.0'))
		set(handles.radio_V20, 'Val', 1),			set(handles.radio_V21, 'Val', 0)
	else
		set(handles.radio_V20, 'Val', 0),			set(handles.radio_V21, 'Val', 1)
	end
...
% ...
	...
	handles.handMir.TDRver       = handles.TDRver;				TDRver = handles.TDRver;
...
% ------------------------------------------------------------------------------------
function radio_V20_CB(hObject, handles)
	if (~get(hObject,'Val')),		set(hObject,'Val', 1),		return,		end
	set(handles.radio_V21,'Val',0)
	handles.TDRver = '2.0';
	guidata(handles.figure1, handles);

% ------------------------------------------------------------------------------------
function radio_V21_CB(hObject, handles)
	if (~get(hObject,'Val')),		set(hObject,'Val', 1),		return,		end
	set(handles.radio_V20,'Val',0)
	handles.TDRver = '2.1';
	guidata(handles.figure1, handles);
...
set(h1,	'Position',[520 437 275 363],...
...
uicontrol('Parent',h1,'Position',[4 5 266 331],'Enable','off','BackgroundColor',fUiBgColor+0.002);
uicontrol('Parent',h1,'Position',[10 269 111 50],'Style','frame','UserData','general');

uicontrol('Parent',h1,'Position',[20 293 90 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_geog_CB'},...
'String','Geographic',...
'Style','radiobutton',...
...
'Callback',{@mirone_pref_uiCB,h1,'radio_cart_CB'},...
'String','Cartesian',...
'Style','radiobutton',...
...
uicontrol('Parent',h1, 'Position',[134 297 36 21], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'edit_GridMaxSize_CB'},...
...
uicontrol('Parent',h1, 'Position',[134 272 36 21], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'edit_swathRatio_CB'},...
'HorizontalAlignment','center',...
'String','3',...
'Style','edit',...
...
uicontrol('Parent',h1, 'Position',[10 217 101 22], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'popup_MeasureUnites_CB'},...
...
uicontrol('Parent',h1, 'Position',[120 217 145 22], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'popup_ellipsoide_CB'},...
'String','WGS84',...
'Style','popupmenu',...
...
uicontrol('Parent',h1, 'Position',[10 166 236 22], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'popup_directory_list_CB'},...
...
'Callback',{@mirone_pref_uiCB,h1,'push_change_dir_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
...
'Callback',{@mirone_pref_uiCB,h1,'checkbox_meanLat_CB'},...
...
uicontrol('Parent',h1, 'Position',[10 115 230 15],...
'Callback',{@mirone_pref_uiCB,h1,'checkbox_ForceInsitu_CB'},...
'String','Force "Insitu" transposition',...
'Style','checkbox',...
'Tag','checkbox_ForceInsitu',...
'UserData','general');

uicontrol('Parent',h1, 'Position',[10 90 230 15],...
'Callback',{@mirone_pref_uiCB,h1,'check_movePolyg_CB'},...
...
uicontrol('Parent',h1, 'Position',[10 41 100 22], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'popup_DefLineThickness_CB'},...
...
uicontrol('Parent',h1, 'Position',[144 41 100 22], 'BackgroundColor',[1 1 1],...
'Callback',{@mirone_pref_uiCB,h1,'popup_DefLineColor_CB'},...
...
'Callback',{@mirone_pref_uiCB,h1,'push_OK_CB'},...
'String','OK',...
'Tag','push_OK');

% -------------------- 	FLEDERMAUS TAB ---------------------------------------- 
% --- Group 1
uicontrol('Parent',h1,'Position',[27 290 220 30],...
'FontAngle','italic','FontSize',12,'FontWeight','demi', 'HorizontalAlignment','left',...
'String','Which one?',...
'Style','text', 'UserData','fleder');

uicontrol('Parent',h1,'Position',[28 280 120 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_iview_CB'},...
...
uicontrol('Parent',h1,'Position',[146 280 120 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_fleder_CB'},...
...
% --- Group 2
uicontrol('Parent',h1,'Position',[27 225 220 30],...
'FontAngle','italic','FontSize',12,'FontWeight','demi', 'HorizontalAlignment','left',...
'String','What version?',...
'Style','text', 'UserData','fleder');

uicontrol('Parent',h1,'Position',[28 215 110 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_V20_CB'},...
'String','Fleder 6',...
'Style','radiobutton',...
'Tooltip','Write Fleder 6 version files',...
'Value',1,...
'Tag','radio_V20', 'UserData','fleder');

uicontrol('Parent',h1,'Position',[146 215 110 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_V21_CB'},...
'String','Fleder 7',...
'Style','radiobutton',...
'Tooltip','Write Fleder 7 version files',...
'Tag','radio_V21', 'UserData','fleder');
% ------------------------------------------------

% --- Group 3
uicontrol('Parent',h1,'Position',[27 155 220 30],...
'FontAngle','italic','FontSize',12,'FontWeight','demi', 'HorizontalAlignment','left',...
'String','How to deal with Images',...
'Style','text',...
'UserData','fleder');

uicontrol('Parent',h1,'Position',[28 145 110 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_planar_CB'},...
'String','Planar Image',...
'Style','radiobutton',...
'Tooltip','Create planar (2D) images',...
'Value',1,...
'Tag','radio_planar', 'UserData','fleder');

uicontrol('Parent',h1,'Position',[146 145 110 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_spherical_CB'},...
'String','Spherical Image',...
'Style','radiobutton',...
'Tooltip','Create spherical images (wraped on the sphere)',...
'Tag','radio_spherical', 'UserData','fleder');
% ------------------------------------------------

% --- Group 4
uicontrol('Parent',h1,'Position',[28 90 220 30],...
'FontAngle','italic','FontSize',12,'FontWeight','demi', 'HorizontalAlignment','left',...
'String','How to deal with Vectors',...
'Style','text', 'UserData','fleder');

uicontrol('Parent',h1,'Position',[28 80 180 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_coastsOnly_CB'},...
...
uicontrol('Parent',h1,'Position',[28 55 180 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_burnAll_CB'},...
...
uicontrol('Parent',h1,'Position',[28 30 180 15],...
'Callback',{@mirone_pref_uiCB,h1,'radio_noBurnAtAll_CB'},...
...
'Style','text', 'UserData','more');

uicontrol('Parent',h1,'Position',[200 280 21 21],...
'Callback',{@mirone_pref_uiCB,h1,'push_NaNcolor_CB'},...
'UserData','more',...
'Tag','push_NaNcolor');

uicontrol('Parent',h1, 'Position',[25 223 55 15],...
'Callback',{@mirone_pref_uiCB,h1,'check_proxy_CB'},...
'String','proxy?',...
'Style','checkbox',...
'UserData','more',...
'Tag','check_proxy');
...
'Callback',{@mirone_pref_uiCB,h1,'edit_proxyAddress_CB'},...
...
'Callback',{@mirone_pref_uiCB,h1,'edit_proxyPort_CB'},...
'BackgroundColor',[1 1 1],...
'Enable','off',...
'HorizontalAlignment','left',...
'Style','edit',...
