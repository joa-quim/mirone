...
uicontrol('Parent',h1,'Position',[4 334 61 heights(2)],...
...
uicontrol('Parent',h1,'Position',[65 334 80 heights(2)],...
'Callback',{@mirone_pref_uicallback,h1,'tab_group_Callback'},...
'Enable','inactive',...
'String','Fledermaus',...
'ButtonDownFcn',{@mirone_pref_uicallback,h1,'tab_group_ButtonDownFcn'},...
...
uicontrol('Parent',h1,'Position',[172 300 94 15],...
'HorizontalAlignment','left',...
'String','Grid max size (Mb)',...
'Style','text',...
'UserData','general');

uicontrol('Parent',h1,'Position',[172 275 90 15],...
'HorizontalAlignment','left',...
'String','Swath ratio',...
'Style','text',...
'UserData','general');
...
uicontrol('Parent',h1,'Position',[120 10 66 heights(1)],...
'Callback',{@mirone_pref_uicallback,h1,'pushbutton_OK_Callback'},...
'String','OK',...
'Tag','pushbutton_OK');

uicontrol('Parent',h1,'Position',[198 10 66 heights(1)],...
