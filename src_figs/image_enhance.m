...
image_enhance_LayoutFcn(hObject,handles);
handles = guihandles(hObject);
...
% Choose default command line output for image_enhance_export
handles.output = hObject;
guidata(hObject, handles);

% UIWAIT makes image_enhance_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);

set(hObject,'Visible','on');
% NOTE: If you make uiwait active you have also to uncomment the next three lines
% handles = guidata(hObject);
% out = image_enhance_OutputFcn(hObject, [], handles);
% varargout{1} = out;
...
function image_enhance_LayoutFcn(h1,handles);
...
'Position',[65 489 47 18], 'Style','edit', 'Tag','edit_minRange');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[16 491 45 15], 'String','Minimum:', 'Style','text', 'Tag','text1');

uicontrol('Parent',h1, 'BackgroundColor',[0.753 0.753 0.753],...
'Enable','inactive', 'HorizontalAlignment','right',...
'Position',[65 467 47 18], 'Style','edit', 'Tag','edit_maxRange');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[16 470 45 15], 'String','Maximum:', 'Style','text', 'Tag','text2');

uicontrol('Parent',h1, 'BackgroundColor',[1 1 1],...
'Callback',{@image_enhance_uicallback,h1,'edit_minWindow_Callback'},...
'HorizontalAlignment','right', 'Position',[186 489 47 18],...
'Style','edit', 'Tag','edit_minWindow');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[140 491 45 15], 'String','Minimum:', 'Style','text', 'Tag','text6');

uicontrol('Parent',h1, 'BackgroundColor',[1 1 1],...
'Callback',{@image_enhance_uicallback,h1,'edit_maxWindow_Callback'},...
'HorizontalAlignment','right','Position',[186 467 47 18],...
'Style','edit', 'Tag','edit_maxWindow');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[140 470 45 15], 'String','Maximum:', 'Style','text', 'Tag','text7');

uicontrol('Parent',h1, 'BackgroundColor',[1 1 1],...
'Callback',{@image_enhance_uicallback,h1,'edit_widthWindow_Callback'},...
'HorizontalAlignment','right','Position',[294 488 47 18],...
'Style','edit', 'Tag','edit_widthWindow');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[258 490 35 15], 'String','Width:', 'Style','text', 'Tag','text8');

uicontrol('Parent',h1, 'BackgroundColor',[1 1 1],...
'Callback',{@image_enhance_uicallback,h1,'edit_centerWindow_Callback'},...
'HorizontalAlignment','right','Position',[294 466 47 18],...
'Style','edit', 'Tag','edit_centerWindow');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[258 469 35 15], 'String','Center:', 'Style','text', 'Tag','text9');

uicontrol('Parent',h1, 'BackgroundColor',[1 1 1],...
'Callback',{@image_enhance_uicallback,h1,'edit_percentOutliersR_Callback'},...
'Position',[474 470 25 16],'String','2', 'Style','edit',...
...
'Position',[367 486 110 17],'String','Match Data Range',...
'Style','radiobutton',...
...
'Position',[367 465 104 17],'String','Eleminate outliers',...
'Style','radiobutton',...
'TooltipString','Eleminates % outliers as selected in the right side boxe(s)',...
'Tag','radiobutton_delOutliers');

uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[502 470 10 15],'String','%', 'Style','text', 'Tag','text10');

uicontrol('Parent',h1, 'Position',[24 509 65 15],...
...
'Position',[369 438 80 23],...
'String','Apply', 'Tag','push_applyRange');

uicontrol('Parent',h1, 'Position',[370 509 110 15],...
...
'Position',[474 453 25 16], 'String','2', 'Style','edit',...
...
'Position',[474 436 25 16], 'String','2', 'Style','edit',...
