...
'Call',{@bg_region_uiCB,h1,'edit_Ymax_CB'},...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@bg_region_uiCB,h1,'edit_Xmin_CB'},...
'CData',[],...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@bg_region_uiCB,h1,'edit_Xmax_CB'},...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@bg_region_uiCB,h1,'edit_Ymin_CB'},...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'Call',{@bg_region_uiCB,h1,'push_OK_CB'},...
'Position',[185 8 66 21],...
'String','OK',...
'Tag','push_OK');

uicontrol('Parent',h1,...
'Call',{@bg_region_uiCB,h1,'push_Cancel_CB'},...
'Position',[110 8 66 21],...
'String','Cancel',...
'Tag','push_Cancel');
...
function bg_region_uiCB(hObject, eventdata, h1, callback_name)
