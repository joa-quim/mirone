...
% STEP 5. Final
	...
	for (k = 2:4)
		if (~update_report(handles, k))
			msg{k} = sprintf('STEP %d is not done', k-1);
			one = true;		c(k) = false;
		end
	end
...
'Call',{@microlev_uiCB,h1,'popup_FilterType_CB'},...
...
'Call',{@microlev_uiCB,h1,'edit_FilterWidth_CB'},...
...
'Call',{@microlev_uiCB,h1,'push_HelpFilterType_CB'},...
'FontWeight','bold',...
...
'BackgroundColor',[1 1 1],...
'Call',{@microlev_uiCB,h1,'popup_Option_D_CB'},...
'String',{'0'; '1'; '2'; '3'; '4' },...
'Style','popupmenu',...
...
'Call',{@microlev_uiCB,h1,'push_HelpOptionD_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
'String','?',...
...
'BackgroundColor',[1 1 1],...
'Call',{@microlev_uiCB,h1,'edit_loadFiltered_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
...
'Call',{@microlev_uiCB,h1,'push_loadFiltered_CB'},...
'FontSize',9,...
'FontWeight','bold',...
'String','...',...
...
'Call',{@microlev_uiCB,h1,'push_applyStep1_CB'},...
'String','Apply',...
'Tag','push_applyStep1');
...
'Call',{@microlev_uiCB,h1,'push_applyStep2_CB'},...
'String','Apply',...
...
'BackgroundColor',[1 1 1],...
'Call',{@microlev_uiCB,h1,'edit_nWin_CB'},...
'String','3',...
'Style','edit',...
...
'BackgroundColor',[1 1 1],...
'Call',{@microlev_uiCB,h1,'edit_rmsThreshold_CB'},...
'String','6',...
'Style','edit',...
...
'BackgroundColor',[1 1 1],...
'Call',{@microlev_uiCB,h1,'edit_loadMask1_CB'},...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
...
'Call',{@microlev_uiCB,h1,'push_loadMask1_CB'},...
'FontSize',9,...
'FontWeight','bold',...
'String','...',...
'Tag','push_loadMask1');
...
'Call',{@microlev_uiCB,h1,'push_applyStep3_CB'},...
'String','Apply',...
...
'BackgroundColor',[1 1 1],...
'Call',{@microlev_uiCB,h1,'edit_lineThick_CB'},...
'String','2',...
'Style','edit',...
...
'Call',{@microlev_uiCB,h1,'push_maskFromLines_CB'},...
...
'Call',{@microlev_uiCB,h1,'push_loadXY_CB'},...
'FontSize',9,...
'FontWeight','bold',...
'String','...',...
'Tag','push_loadXY');
...
'Call',{@microlev_uiCB,h1,'push_combineMasks_CB'},...
...
function microlev_uiCB(hObject, evt, h1, callback_name)
