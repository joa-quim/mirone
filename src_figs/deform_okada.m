...
% $Id: deform_okada.m 10217 2018-01-24 21:33:46Z j $
	...
	set(handles.edit_sx,'String',sprintf('%.7g',sx(1)))
	set(handles.edit_sy,'String',sprintf('%.7g',sy(1)))
...
function radio_deformation_CB(hObject, handles)
	if get(hObject,'Value')
		...
		set(handles.edit_sx,'String',sprintf('%.7g',handles.sx))
		set(handles.edit_sy,'String',sprintf('%.7g',handles.sy))
		set(handles.edit_sz,'String',sprintf('%.7g',handles.sz))
...
uicontrol('Parent',h1,'Pos',[310 224 221 131],'Style','frame');
uicontrol('Parent',h1,'Pos',[10 224 181 131],'Style','frame');
uicontrol('Parent',h1,'Pos',[10 15 350 67],'Style','frame');
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_okada_uiCB,h1,'edit_x_min_CB'},...
'Pos',[76 162 71 21],...
'Style','edit',...
'Tooltip','X min value',...
'Tag','edit_x_min');
