...
% $Id: travel.m 10217 2018-01-24 21:33:46Z j $
...
% ...
	...
	img = get(handles.hImg,'CData');		% Flipud because of the direct/reverse YDir shit
	handles.hImg = image([west east],[south north],img,'Parent',handles.axes1);
	set(handles.axes1,'PlotBoxAspectRatio',[1 img_pbar 1], 'Vis', 'off')
