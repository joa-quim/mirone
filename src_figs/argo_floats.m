...
% $Id: argo_floats.m 10372 2018-04-12 13:04:26Z j $
...
% JL: This function is modified to work in R13 and depends on GMT
	...
	for (k = 1:numel(yr))  
		...
		try
			...
			ncfiles(length(ncfiles)+1:length(ncfiles)+sum(ind),1) = strcat('https://data.nodc.ncei.gov/argo/gadr/',file_urls(ind));
