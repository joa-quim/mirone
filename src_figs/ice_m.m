...
%
%   EXAMPLES:
%     ice_export OR ice_export('wait', 'off')				% Demo user interface
%     ice_export('image', f)						% Map RGB or mono image
%     ice_export('image', f, 'space', 'hsv')		% Map HSV of RGB image
%     g = ice_export('image', f)					% Return mapped image
%     g = ice_export('image', f, 'wait', 'off');	% Return its handle
%
...
%-------------------------------------------------------------------%
function ice_export_WindowButtonDownFcn(hObject, eventdata, handles)
...
%-------------------------------------------------------------------%
function ice_export_WindowButtonMotionFcn(hObject, eventdata, handles)
...
%-------------------------------------------------------------------%
function ice_export_WindowButtonUpFcn(hObject, eventdata, handles)
...
%-------------------------------------------------------------------%
function check_cdf_Callback(hObject, eventdata, handles)
...
%-------------------------------------------------------------------%
function check_mapbar_Callback(hObject, eventdata, handles)
...
%-------------------------------------------------------------------%
function check_mapimage_Callback(hObject, eventdata, handles)
...
'RendererMode','manual',...
'WindowButtonDownFcn','ice_export(''ice_WindowButtonDownFcn'',gcbo,[],guidata(gcbo))',...
'WindowButtonMotionFcn','ice_export(''ice_WindowButtonMotionFcn'',gcbo,[],guidata(gcbo))',...
'WindowButtonUpFcn','ice_export(''ice_WindowButtonUpFcn'',gcbo,[],guidata(gcbo))',...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'check_smooth_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'push_reset_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'check_slope_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'push_resetall_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'check_pdf_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'check_cdf_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'check_mapbar_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'Callback',{@ice_m_uicallback,h1,'check_mapimage_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
...
'Callback',{@ice_m_uicallback,h1,'popup_colorSpace_Callback'},...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@ice_m_uicallback,h1,'popup_component_Callback'},...
'FontSize',10,...
...
function ice_m_uicallback(hObject, eventdata, h1, callback_name)
