...
uicontrol('Parent',h1, 'Position',[5 221 21 128], 'Style','frame', 'Tag','frame_top');
uicontrol('Parent',h1, 'Position',[5 8 285 207], 'Style','frame', 'Tag','frame_bot');
