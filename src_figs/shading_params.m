...
% $Id: shading_params.m 10417 2018-05-28 20:09:23Z j $
	...
	if (~strcmp(varargin{1},'dirDerivative'))
		...
		if (varargin{2} == 0)		% No shadded fig, no need for this option
			set(handles.ui_noShade, 'Enable', 'off')
		end
...
set(h1, 'Position',[520 400 320 150],...
...
uicontrol('Parent',h1, 'Position',[56 6 34 21],...
...
uicontrol('Parent',h1, 'Position',[131 6 30 21],...
'BackgroundColor',[1 1 1],...
'String','30',...
'Style','edit',...
...
uicontrol('Parent',h1, 'Position',[186 102 30 21],...
'BackgroundColor',[1 1 1],...
'String','.55',...
'Style','edit',...
'Tag','edit_ambient');

uicontrol('Parent',h1, 'Position',[186 79 30 21],...
'BackgroundColor',[1 1 1],...
'String','.6',...
'Style','edit',...
'Tag','edit_diffuse');

uicontrol('Parent',h1, 'Position',[186 56 30 21],...
'BackgroundColor',[1 1 1],...
'String','.4',...
'Style','edit',...
'Tag','edit_specular');

uicontrol('Parent',h1, 'Position',[186 33 30 21],...
'BackgroundColor',[1 1 1],...
'String','10',...
'Style','edit',...
'Tag','edit_shine');

uicontrol('Parent',h1, 'Position',[219 102 70 16],...
'HorizontalAlignment','left',...
'String','Ambient light',...
'Style','text',...
'Tag','text_ambient');

uicontrol('Parent',h1, 'Position',[219 78 83 17],...
'HorizontalAlignment','left',...
'String','Diffuse reflection',...
'Style','text',...
'Tag','text_diffuse');

uicontrol('Parent',h1, 'Position',[219 57 91 15],...
'HorizontalAlignment','left',...
'String','Specular reflection',...
'Style','text',...
'Tag','text_reflection');

uicontrol('Parent',h1, 'Position',[219 35 77 15],...
'HorizontalAlignment','left',...
'String','Specular shine',...
'Style','text',...
'Tag','text_shine');

uicontrol('Parent',h1, 'Position',[13 7 42 16],...
'FontSize',9,...
'HorizontalAlignment','left',...
'String','Azimuth',...
'Style','text',...
...
uicontrol('Parent',h1, 'Position',[123 104 50 16],...
'FontSize',9,...
'String','Elevation',...
'Style','text',...
'Tag','text_elev');
...
uicontrol('Parent',h1, 'Position',[10 6 34 21],...
...
uicontrol('Parent',h1, 'Position',[44 6 34 21],...
...
uicontrol('Parent',h1, 'Position',[79 6 34 21],...
...
uicontrol('Parent',h1, 'Position',[187 101 87 23],...
'Callback',@shading_params_uiCB,...
...
uicontrol('Parent',h1, 'Position',[187 45 87 23],...
'Callback',@shading_params_uiCB,...
'String','grdgradient',...
'Style','radiobutton',...
...
uicontrol('Parent',h1, 'Position',[229 6 66 21],...
'Callback',@shading_params_uiCB,...
'String','OK',...
'Tag','push_OK');
