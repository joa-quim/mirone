...
'Call',{@manual_pole_adjust_uiCB,h1,'edit_lon_CB'},...
'Style','edit',...
'Tag','edit_lon');

uicontrol('Parent',h1, 'Position',[78 75 471 18],...
'BackgroundColor',[0.9 0.9 0.9],...
'Call',{@manual_pole_adjust_uiCB,h1,'slider_lon_CB'},...
'Max',360,...
'Min',-180,...
'Style','slider',...
...
'BackgroundColor',[1 1 1],...
'Call',{@manual_pole_adjust_uiCB,h1,'edit_lat_CB'},...
'Style','edit',...
'Tag','edit_lat');

uicontrol('Parent',h1, 'Position',[78 44 471 18],...
'BackgroundColor',[0.9 0.9 0.9],...
'Call',{@manual_pole_adjust_uiCB,h1,'slider_lat_CB'},...
'Max',90,...
'Min',-90,...
'Style','slider',...
'SliderStep',[0.001 0.01],...
...
'BackgroundColor',[1 1 1],...
'Call',{@manual_pole_adjust_uiCB,h1,'edit_omega_CB'},...
'Style','edit',...
'Tag','edit_omega');

uicontrol('Parent',h1, 'Position',[78 15 471 18],...
'BackgroundColor',[0.9 0.9 0.9],...
'Call',{@manual_pole_adjust_uiCB,h1,'slider_omega_CB'},...
'Max',90,...
'Min',-90,...
'Style','slider',...
...
'Call',{@manual_pole_adjust_uiCB,h1,'toggle_pickLine_CB'},...
...
'Call',{@manual_pole_adjust_uiCB,h1,'check_geodetic_CB'},...
'String','Geodetic',...
...
'Call',{@manual_pole_adjust_uiCB,h1,'push_polesList_CB'},...
...
function manual_pole_adjust_uiCB(hObject, eventdata, h1, callback_name)
