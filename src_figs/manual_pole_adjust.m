...
'Callback',{@manual_pole_adjust_uiCB,h1,'edit_lon_CB'},...
...
'Callback',{@manual_pole_adjust_uiCB,h1,'slider_lon_CB'},...
'Max',360,...
'Min',-180,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@manual_pole_adjust_uiCB,h1,'edit_lat_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',{@manual_pole_adjust_uiCB,h1,'slider_lat_CB'},...
'Max',90,...
'Min',-90,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@manual_pole_adjust_uiCB,h1,'edit_omega_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[0.9 0.9 0.9],...
'Callback',{@manual_pole_adjust_uiCB,h1,'slider_omega_CB'},...
'Max',90,...
'Min',-90,...
...
'Callback',{@manual_pole_adjust_uiCB,h1,'toggle_pickLine_CB'},...
