...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_FaultWidth_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_FaultDip_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_FaultDepth_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_FaultTopDepth_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'popup_segment_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_DislocStrike_CB'},...
'Position',[330 213 51 21],...
'Style','edit',...
'Tag','edit_DislocStrike');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_DislocRake_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_DislocSlip_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_x_min_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_x_inc_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_y_inc_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_Nrows_CB'},...
...
'Call',{@deform_mansinha_uiCB,h1,'pushbutton_Help_R_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'popup_fault_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@deform_mansinha_uiCB,h1,'checkbox_hideFaultPlanes_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'edit_qValue_CB'},...
...
'Call',{@deform_mansinha_uiCB,h1,'edit_mu_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@deform_mansinha_uiCB,h1,'popup_GridCoords_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@deform_mansinha_uiCB,h1,'push_focal_CB'},...
'Position',[380 51 29 29],...
'Tooltip','Show focal mechanism',...
'Tag','push_focal');

uicontrol('Parent',h1,...
'Call',{@deform_mansinha_uiCB,h1,'push_compute_CB'},...
'FontWeight','bold',...
'Position',[430 15 71 21],...
'String','Compute',...
'Tag','push_compute');

function deform_mansinha_uiCB(hObject, eventdata, h1, callback_name)
