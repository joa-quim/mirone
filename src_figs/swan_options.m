...
% $Id: swan_options.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@swan_options_uiCB,h1,'edit_BatGrid_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'push_BatGrid_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_SourceGrid_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'push_SourceGrid_CB'},...
'Position',[331 273 23 23],...
'Tag','push_SourceGrid',...
'UserData','main');

uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_outGrids_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_anuga_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_most_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_surfLevel_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_maxWater_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_totalWater_CB'},...
'Enable','off',...
...
'Callback',{@swan_options_uiCB,h1,'check_wantMaregs_CB'},...
'String','Maregraphs',...
'Style','checkbox',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_MaregraphPosFile_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'push_MaregraphPosFile_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_MaregraphDataFile_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@swan_options_uiCB,h1,'push_MaregraphDataFile_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_Number_of_cycles_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_SwanParams_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'push_paramsFile_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_jumpInitial_CB'},...
'CData',[],...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_friction_CB'},...
'CData',[],...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_dt_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_grn_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_cartesian_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'radio_geog_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@swan_options_uiCB,h1,'edit_cumint_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'push_OK_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Callback',{@swan_options_uiCB,h1,'push_Cancel_CB'},...
'FontWeight','bold',...
