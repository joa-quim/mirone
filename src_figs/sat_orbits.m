...
% $Id: sat_orbits.m 10217 2018-01-24 21:33:46Z j $
...
% DATA = [YYYY MM DD hh mm ss]
	...
	uimenu(cmenuHand, 'Label', 'Delete this patch', 'Callback', 'delete(gco)');
	uimenu(cmenuHand, 'Label', 'Delete all patches', 'Callback', {@del_patches, h});
	...
	uimenu(cmenuHand, 'Label', L2_name_SST, 'Callback', {@display_url,url}, 'Sep','on');
 	url = ['http://oceandata.sci.gsfc.nasa.gov/cgi/getfile/' L2_name_OC];
	uimenu(cmenuHand, 'Label', L2_name_OC, 'Callback', {@display_url,url}, 'Sep','on');
