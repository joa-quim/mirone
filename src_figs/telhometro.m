...
% $Id: telhometro.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@telhometro_uiCB,h1,'edit_polesFile_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@telhometro_uiCB,h1,'push_readPolesFile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Callback',{@telhometro_uiCB,h1,'push_compute_CB'},...
'FontSize',9,...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Callback',{@telhometro_uiCB,h1,'push_callMagBarCode_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@telhometro_uiCB,h1,'push_polesList_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@telhometro_uiCB,h1,'push_pickLine_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@telhometro_uiCB,h1,'edit_timeStart_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@telhometro_uiCB,h1,'edit_timeEnd_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@telhometro_uiCB,h1,'edit_poleLon_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@telhometro_uiCB,h1,'edit_poleLat_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@telhometro_uiCB,h1,'edit_poleAng_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@telhometro_uiCB,h1,'check_additionalRot_CB'},...
