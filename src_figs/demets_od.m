...
% $Id: demets_od.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@demets_od_uiCB,h1,'toggle_pickLines_CB'},...
...
'Callback',{@demets_od_uiCB,h1,'edit_pLon_ini_CB'},...
'String','',...
'Style','edit',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@demets_od_uiCB,h1,'edit_pLat_ini_CB'},...
'String','',...
'Style','edit',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@demets_od_uiCB,h1,'edit_pAng_ini_CB'},...
'String','',...
'Style','edit',...
...
'Callback',{@demets_od_uiCB,h1,'push_polesList_CB'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@demets_od_uiCB,h1,'edit_ODfile_CB'},...
...
'Callback',{@demets_od_uiCB,h1,'push_ODfile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
'Tag','push_ODfile');
...
'Callback',{@demets_od_uiCB,h1,'push_OK_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','OK',...
'Tag','push_OK');
