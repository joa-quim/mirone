...
% $Id: world_is_not_round_enough.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@world_NRE_uiCB,h1,'edit_xMin_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@world_NRE_uiCB,h1,'push_apply_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
...
uicontrol('Parent',h1,...
'Callback',{@world_NRE_uiCB,h1,'push_to360_CB'},...
'FontName','Helvetica',...
'Position',pos,...
...
uicontrol('Parent',h1,...
'Callback',{@world_NRE_uiCB,h1,'push_to180_CB'},...
'FontName','Helvetica',...
'Position',pos,...
