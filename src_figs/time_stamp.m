...
'Callback',{@main_uiCB,h1,'edit_Xpos_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_Ypos_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'popup_Unities_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_Label_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'checkbox_PlotCommand_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_ShowCommand_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_Cancel_CB'},...
