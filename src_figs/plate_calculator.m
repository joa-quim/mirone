...
% $Id: plate_calculator.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@plate_calculator_uiCB,h1,'radio_Nuvel1A_CB','Nuvel1A'},...
'String','Nuvel-1A',...
'Style','radiobutton',...
'Value',1,...
'Tag','radio_Nuvel1A');
...
'Callback',{@plate_calculator_uiCB,h1,'radio_Nuvel1A_CB','MORVEL'},...
'String','MORVEL',...
'Style','radiobutton',...
'Value',0,...
'Tag','radio_MORVEL');
...
'Callback',{@plate_calculator_uiCB,h1,'radio_PBird_CB'},...
'String','P. Bird',...
'Style','radiobutton',...
'Tag','radio_PBird');

uicontrol('Parent',h1, 'Position',[14 225 71 15],...
'Callback',{@plate_calculator_uiCB,h1,'radio_GEODVEL_CB'},...
'String','GEODVEL',...
'Style','radiobutton',...
'Tag','radio_GEODVEL');

uicontrol('Parent',h1, 'Position',[108 285 100 15],...
'Callback',{@plate_calculator_uiCB,h1,'radio_Nuvel1A_NNR_CB'},...
'String','Nuvel-1A NNR',...
'Style','radiobutton',...
'Tag','radio_Nuvel1A_NNR');

uicontrol('Parent',h1, 'Position',[108 265 87 15],...
'Callback',{@plate_calculator_uiCB,h1,'radio_DEOS2K_CB'},...
'String','DEOS2K',...
'Style','radiobutton',...
'Tag','radio_DEOS2K');

uicontrol('Parent',h1, 'Position',[108 245 87 15],...
'Callback',{@plate_calculator_uiCB,h1,'radio_REVEL_CB'},...
'String','REVEL',...
'Style','radiobutton',...
'Tag','radio_REVEL');
...
'Callback',{@plate_calculator_uiCB,h1,'popup_PickPlate_CB', 'fixed'},...
'Style','popupmenu',...
'Value',1,...
...
'BackgroundColor',[1 1 1],...
'Callback',{@plate_calculator_uiCB,h1,'popup_PickPlate_CB', 'mobile'},...
'Style','popupmenu',...
'Value',1,...
...
'BackgroundColor',[1 1 1],...
'Callback',{@plate_calculator_uiCB,h1,'edit_PtLon_CB'},...
'Style','edit',...
'Tag','edit_PtLon');
...
'BackgroundColor',[1 1 1],...
'Callback',{@plate_calculator_uiCB,h1,'edit_PtLat_CB'},...
'Style','edit',...
'Tag','edit_PtLat');

uicontrol('Parent',h1, 'Position',[205 120 66 21],...
'Callback',{@plate_calculator_uiCB,h1,'push_Calculate_CB'},...
'FontSize',9,...
'FontWeight','bold',...
'String','Calculate',...
'Tag','push_Calculate');
...
'Callback',{@plate_calculator_uiCB,h1,'push_Readme_CB'},...
'FontSize',9,...
'FontWeight','demi',...
...
'Callback',{@plate_calculator_uiCB,h1,'checkbox_Abs2Rel_CB'},...
'String','Relativize',...
'Style','checkbox',...
