...
% For compiling one need to include the aqua_suppfuns.m files.
	...
	handles.ranges = cell(17,1);		% 17 = 3 (direct vars) + 14 (derived vars)
	handles.elevRange = [];
...
% ...
	...
	if (~isempty(U))		% Plot vectors
		...
		uimenu(cmenuHand, 'Label', 'Save arrows', 'Callback', {@save_arrows, handles.hQuiver(1)});
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'tab_group_CB'},...
'Enable','inactive',...
...
'Callback',{@aquamoto_uiCB,h1,'edit_batGrid_CB'},...
...
'Callback',{@aquamoto_uiCB,h1,'push_batGrid_CB'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_singleWater_CB'},...
'HorizontalAlignment','left',...
'Style','edit',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_singleWater_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_namesList_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_namesList_CB'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'listbox1_CB'},...
'Style','listbox',...
'Value',1,...
'Tag','listbox1',...
'UserData','t_grids');
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'toggle_1_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'toggle_2_CB'},...
...
'Callback',{@aquamoto_uiCB2,h1,[],'push_OK_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
'String','Do it',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_OK_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
...
uicontrol('Parent',h1, 'Position',[431 246 50 15],...
'Callback',{@aquamoto_uiCB,h1,'radio_avi_CB'},...
'FontName','Helvetica',...
'String','AVI',...
'Style','radiobutton',...
...
uicontrol('Parent',h1, 'Position',[519 537 50 17],...
'Callback',{@aquamoto_uiCB,h1,'radio_land_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','Land',...
'Style','radiobutton',...
...
uicontrol('Parent',h1, 'Position',[618 535 55 17],...
'Callback',{@aquamoto_uiCB,h1,'radio_water_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','Water',...
'Style','radiobutton',...
...
uicontrol('Parent',h1, 'Position',[431 266 50 15],...
'Callback',{@aquamoto_uiCB,h1,'radio_gif_CB'},...
'FontName','Helvetica',...
'String','GIF',...
'Style','radiobutton',...
...
uicontrol('Parent',h1, 'Position',[550 269 55 15],...
'FontName','Helvetica',...
'String','Dither',...
'Style','checkbox',...
...
uicontrol('Parent',h1, 'Position',[432 288 70 15],...
'FontName','Helvetica',...
'FontSize',9,...
'String','Movie type',...
'Style','text',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_fps_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_clearTestBat_CB'},...
'FontName','Helvetica',...
'FontSize',7,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'popup_resize_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_movieName_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_movieName_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'radio_mpg_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_palette_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'check_resetCmaps_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_landPhoto_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_landPhoto_CB'},...
...
'Callback',{@aquamoto_uiCB,h1,'slider_layer_CB'},...
'Enable','inactive',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_swwName_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_swwName_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_x_inc_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_y_inc_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_Ncols_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_Nrows_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@aquamoto_uiCB,h1,'push_Help_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_x_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_showMesh_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_sliceNumber_CB'},...
'Enable','inactive',...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'radio_stage_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'radio_xmoment_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'radio_ymoment_CB'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'popup_derivedVar_CB'},...
'Enable','off',...
...
'Callback',{@aquamoto_uiCB,h1,'check_derivedVar_CB'},...
'String','Derived var',...
'Style','checkbox',...
...
'Callback',{@aquamoto_uiCB,h1,'push_vel_CB'},...
'Enable','off',...
'Style','pushbutton',...
...
'Callback',{@aquamoto_uiCB,h1,'slider_transparency_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_showSlice_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_globalWaterMax_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_globalWaterMin_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@aquamoto_uiCB,h1,'push_checkGlobalMM_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_maregs_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@aquamoto_uiCB,h1,'push_maregs_CB'},...
...
'Callback',{@aquamoto_uiCB,h1,'push_runIn_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
'FontWeight','bold',...
'String','Plot Run In',...
...
'Callback',{@aquamoto_uiCB,h1,'radio_noShade_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','No shading',...
'Style','radiobutton',...
...
'Callback',{@aquamoto_uiCB,h1,'radio_shade_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','Shading',...
'Style','radiobutton',...
...
'Callback',{@aquamoto_uiCB,h1,'push_apply_CB'},...
'String','Apply',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_multiLayerInc_CB'},...
'Enable','off',...
'String','1',...
'Style','edit',...
...
'Callback',{@aquamoto_uiCB,h1,'radio_multiLayer_CB'},...
'FontName','Helvetica',...
...
'Callback',{@aquamoto_uiCB,h1,'radio_timeGridsList_CB'},...
'FontName','Helvetica',...
...
'Callback',{@aquamoto_uiCB,h1,'push_interpolate_CB'},...
'Enable','off',...
'String','Interpolate',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@aquamoto_uiCB,h1,'edit_miscLayerInc_CB'},...
'Enable','off',...
'String','1',...
'Style','edit',...
'TooltipString','Slice increment. ''1'' means all layers, ''2'', every other layer. The ML start:inc:end form is acepted as well',...
...
'Callback',{@vector_plot_uiCB,h1,'push_vp_OK_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','OK',...
'Tag','push_vp_OK');
...
'Callback',{@vector_plot_uiCB,h1,'push_vp_cancel_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','Cancel',...
'Tag','push_vp_cancel');
...
'Callback',{@vector_plot_uiCB,h1,'radio_plotVec_CB'},...
'String','Plot vectors',...
'Style','radiobutton',...
'Tag','radio_plotVec');

uicontrol('Parent',h1,'Position',[100 156 55 15],...
'Callback',{@vector_plot_uiCB,h1,'radio_noPlot_CB'},...
'String','No plot',...
'Style','radiobutton',...
'Value',1,...
'Tag','radio_noPlot');
...
'Callback',{@vector_plot_uiCB,h1,'slider_scale_CB'},...
'Style','slider',...
'Max',20, 'Min',1,...
...
'BackgroundColor',[0.96 0.96 0.96],...
'Callback',{@vector_plot_uiCB,h1,'slider_spacing_CB'},...
'Style','slider',...
'Max',100, 'Min',1,...
