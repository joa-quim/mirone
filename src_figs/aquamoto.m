...
% -----------------------------------------------------------------------------------------
function push_plugFun_Callback(hObject, eventdata, handles)
...
uicontrol('Parent',h1, 'Position',[335 399 46 23],...
'Callback',{@aquamoto_uicallback,h1,'tab_group_Callback'},...
'Enable','inactive',...
'String','Plug',...
'ButtonDownFcn',{@aquamoto_uicallback,h1,'tab_group_ButtonDownFcn'},...
...
uicontrol('Parent',h1, 'Position',[61 399 70 23],...
'Callback',{@aquamoto_uicallback,h1,'tab_group_Callback'},...
'Enable','inactive',...
'String','Time Grids',...
'ButtonDownFcn',{@aquamoto_uicallback,h1,'tab_group_ButtonDownFcn'},...
...
uicontrol('Parent',h1, 'Position',[420 173 181 41],...
'Style','frame',...
'Tag','frame5',...
'UserData','cinema');

uicontrol('Parent',h1, 'Position',[690 190 221 41],...
'Style','frame',...
'Tag','frame6',...
'UserData','t_grids');

 uicontrol('Parent',h1, 'Position',[420 238 181 58],...
'Style','frame',...
'Tag','frame4',...
'UserData','cinema');
...
uicontrol('Parent',h1, 'Position',[30 72 100 23],...
...
uicontrol('Parent',h1, 'Position',[370 420 81 23],...
...
uicontrol('Parent',h1, 'Position',[355 115 104 16],...
...
uicontrol('Parent',h1, 'Position',[690 110 110 23],...
...
'Callback',{@aquamoto_uicallback,h1,'push_plugFun_Callback'},...
