...
% $Id: geog_calculator.m 10217 2018-01-24 21:33:46Z j $
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_tab_bg_CB'},...
'Enable','inactive',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_zLeft_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@geog_calculator_uiCB,h1,'push_fileLeft_CB'},...
'Tag','push_fileLeft',...
'UserData','FileConv');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_fileLeft_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'checkbox_nHeadersLeft_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_nHeadersLeft_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'checkbox_ToggleXYLeft_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'checkbox_ellipsoidHeightsLeft_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_fileRight_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_fileRight_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_DefCoordLeft_CB'},...
'FontAngle','oblique',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'popup_UnitesLeft_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_DefCoordRight_CB'},...
'FontAngle','oblique',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'popup_UnitesRight_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_left2right_CB'},...
'FontSize',11,...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_right2left_CB'},...
'FontSize',11,...
'FontWeight','bold',...
'ForegroundColor',[0 0.250980392156863 0.501960784313725],...
...
'Callback',{@geog_calculator_uiCB,h1,'push_gridLeft_CB'},...
'Tag','push_gridLeft',...
'UserData','GridConv');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_gridLeft_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_xIncRight_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_yIncRight_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_nColsRight_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_nRowsRight_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@geog_calculator_uiCB,h1,'push_gridRight_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@geog_calculator_uiCB,h1,'edit_optDPI_CB'},...
