...
% -------------------------------------------------------------------------------------
function edit_polesFile_CB(hObject, eventdata, handles)
fname = get(hObject,'String');
if isempty(fname),		return;    end
% Let the pushbutton_readPolesFile_CB do all the work
pushbutton_readPolesFile_CB(hObject,[],guidata(gcbo),fname)

% -------------------------------------------------------------------------------------
function pushbutton_readPolesFile_CB(hObject, eventdata, handles, opt)
% Get poles file name
...
% -------------------------------------------------------------------------------------
function edit_agesFile_CB(hObject, eventdata, handles)
	fname = get(hObject,'String');
	if isempty(fname),	return;    end
	id = strfind(fname,':');
	if (~isempty(id))
		...
		guidata(hObject, handles);
	else				% Let the pushbutton_ReadAgesFile_CB do all the work
		pushbutton_ReadAgesFile_CB(hObject,[],guidata(gcbo),fname)
	end

% -------------------------------------------------------------------------------------
function pushbutton_ReadAgesFile_CB(hObject, eventdata, handles, opt)
...
% -------------------------------------------------------------------------------------
function pushbutton_compute_CB(hObject, eventdata, handles)
...
% --------------------------------------------------------------------
function pushbutton_callMagBarCode_CB(hObject, eventdata, handles)
	MagBarCode([handles.path_data 'Cande_Kent_95.dat'])

% --------------------------------------------------------------------
function edit_poleLon_CB(hObject, eventdata, handles)
...
% --------------------------------------------------------------------
function edit_poleLat_CB(hObject, eventdata, handles)
	xx = str2double(get(hObject,'String'));
	if (isnan(xx))
		set(hObject,'String','')
		handles.p_lat = [];
...
% --------------------------------------------------------------------
function edit_poleAngle_CB(hObject, eventdata, handles)
	xx = str2double(get(hObject,'String'));
	if (isnan(xx))
		set(hObject,'String','')
		handles.p_omega = [];
...
% --------------------------------------------------------------------
function checkbox_singleRotation_CB(hObject, eventdata, handles)
...
% --------------------------------------------------------------------
function pushbutton_polesList_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function push_pickLine_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function push_rectSelect_CB(hObject, eventdata, handles)
    % Test if we have potential target lines and their type
    h_mir_lines = findobj(handles.h_calling_fig,'Type','line');     % Fish all objects of type line in Mirone figure
...
% -----------------------------------------------------------------------------------
function edit_pole1Lon_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function edit_pole1Lat_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function edit_pole1Ang_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function edit_pole2Lon_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function edit_pole2Lat_CB(hObject, eventdata, handles)
...
% -----------------------------------------------------------------------------------
function edit_pole2Ang_CB(hObject, eventdata, handles)
...
'Callback',{@euler_stuff_uicallback,h1,'tab_group_CB'},...
'Enable','inactive',...
'String','Add poles',...
...
'Callback',{@euler_stuff_uicallback,h1,'edit_polesFile_CB'},...
...
'Callback',{@euler_stuff_uicallback4,h1,[],'pushbutton_readPolesFile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_agesFile_CB'},...
'HorizontalAlignment','left',...
'Style','edit',...
'Tag','edit_agesFile',...
...
'Callback',{@euler_stuff_uicallback4,h1,[],'pushbutton_ReadAgesFile_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','...',...
...
'Callback',{@euler_stuff_uicallback,h1,'pushbutton_compute_CB'},...
'String','Compute',...
...
'Callback',{@euler_stuff_uicallback,h1,'pushbutton_callMagBarCode_CB'},...
...
'Callback',{@euler_stuff_uicallback,h1,'edit_poleLon_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_poleLat_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_poleAngle_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'Callback',{@euler_stuff_uicallback,h1,'checkbox_singleRotation_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@euler_stuff_uicallback,h1,'pushbutton_polesList_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@euler_stuff_uicallback,h1,'push_pickLine_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@euler_stuff_uicallback,h1,'push_rectSelect_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_pole1Lon_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_pole1Lat_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_pole1Ang_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_pole2Lon_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_pole2Lat_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@euler_stuff_uicallback,h1,'edit_pole2Ang_CB'},...
