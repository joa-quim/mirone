...
'Call',{@grid_calculator_uiCB,h1,'edit_command_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grid_calculator_uiCB,h1,'listbox_inArrays_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_1_CB'},...
'FontSize',10,...
'Position',[341 105 23 23],...
'String','1','Tag','push_1');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_2_CB'},...
'FontSize',10,...
'Position',[374 105 23 23],...
'String','2','Tag','push_2');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_3_CB'},...
'FontSize',10,...
'Position',[407 105 23 23],...
'String','3','Tag','push_3');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_4_CB'},...
'FontSize',10,...
'Position',[341 72 23 23],...
'String','4','Tag','push_4');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_5_CB'},...
'FontSize',10,...
'Position',[374 72 23 23],...
'String','5','Tag','push_5');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_6_CB'},...
'FontSize',10,...
'Position',[407 72 23 23],...
'String','6','Tag','push_6');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_7_CB'},...
'FontSize',10,...
'Position',[341 39 23 23],...
'String','7','Tag','push_7');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_8_CB'},...
'FontSize',10,...
'Position',[374 39 23 23],...
'String','8','Tag','push_8');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_9_CB'},...
'FontSize',10,...
'Position',[407 39 23 23],...
'String','9','Tag','push_9');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_0_CB'},...
'FontSize',10,...
'Position',[341 6 23 23],...
'String','0','Tag','push_0');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_dot_CB'},...
'FontSize',10,...
'Position',[374 6 23 23],...
'String','.','Tag','push_dot');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_equal_CB'},...
'FontSize',10,...
'Position',[407 6 23 23],...
'String','=','Tag','push_equal');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_devide_CB'},...
'FontSize',10,...
'Position',[440 105 23 23],...
'String','/','Tag','push_devide');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_mull_CB'},...
'FontSize',10,...
'Position',[440 72 23 23],...
'String','*','Tag','push_mull');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_minus_CB'},...
'FontSize',10,...
'Position',[440 39 23 23],...
'String','-','Tag','push_minus');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_plus_CB'},...
'FontSize',10,...
'Position',[440 6 23 23],...
'String','+','Tag','push_plus');

uicontrol('Parent',h1,...
'Call',{@grid_calculator_uiCB,h1,'push_loadGrid_CB'},...
'FontSize',10,...
...
function grid_calculator_uiCB(hObject, eventdata, h1, callback_name)
