...
'Call',{@focal_meca_uiCB,h1,'listbox_readFilter_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@focal_meca_uiCB,h1,'push_readFile_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@focal_meca_uiCB,h1,'edit_MagMin_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@focal_meca_uiCB,h1,'edit_MagMax_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@focal_meca_uiCB,h1,'edit_Mag5_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@focal_meca_uiCB,h1,'edit_DepthMin_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@focal_meca_uiCB,h1,'edit_DepthMax_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@focal_meca_uiCB,h1,'push_OK_CB'},...
...
function focal_meca_uiCB(hObject, eventdata, h1, callback_name)
