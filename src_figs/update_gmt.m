...
% $Id: update_gmt.m 10217 2018-01-24 21:33:46Z j $
...
uicontrol('Parent',h1, 'Position',[470 100 23 23],...
'Callback',@updateGMT_uiCB,...
'FontWeight','bold',...
'String','...',...
...
uicontrol('Parent',h1, 'Position',[470 60 23 23],...
'Callback',@updateGMT_uiCB,...
'FontWeight','bold',...
'String','...',...
