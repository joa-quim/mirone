...
% $Id: animate_seismicity.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@main_uiCB,h1,'edit_StartYear_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_StartMonth_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_StartDay_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_EndYear_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_EndMonth_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_EndDay_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_timeStep_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_lifeSpan_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_frameDelay_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_stop_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_run_CB'},...
...
'Callback',{@main_uiCB,h1,'slider_time_CB'},...
