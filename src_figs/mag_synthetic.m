...
uicontrol('Parent',h1,'Position',[10 10 301 381],'Style','frame','Tag','frame5');
uicontrol('Parent',h1,'Position',[20 270 281 103],'Style','frame','Tag','frame3');
uicontrol('Parent',h1,'Position',[20 179 281 83],'Style','frame','Tag','frame2');
uicontrol('Parent',h1,'Position',[20 69 281 101],'Style','frame','Tag','frame1');

uicontrol('Parent',h1,'Position',[30 327 72 21],...
'Callback',{@mag_synthetic_uiCB,h1,'edit_speed_CB'},...
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_spreadingDir_CB'},...
'BackgroundColor',[1 1 1],...
'String','',...
'Style','edit',...
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_decl_CB'},...
'BackgroundColor',[1 1 1],...
'String','',...
'Style','edit',...
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_inc_CB'},...
'BackgroundColor',[1 1 1],...
'String','',...
'Style','edit',...
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_contamin_CB'},...
'BackgroundColor',[1 1 1],...
'String','1',...
'Style','edit',...
'Tag','edit_contamin');
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_ageInit_CB'},...
'BackgroundColor',[1 1 1],...
'String','',...
'Style','edit',...
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_depthZero_CB'},...
'BackgroundColor',[1 1 1],...
'String','3',...
'Style','edit',...
...
'Callback',{@mag_synthetic_uiCB,h1,'check_batGrid_CB'},...
...
'Callback',{@mag_synthetic_uiCB,h1,'edit_batGrid_CB'},...
...
'Callback',{@mag_synthetic_uiCB,h1,'push_batGrid_CB'},...
'FontSize',9,...
'FontWeight','bold',...
'String','...',...
'Tag','push_batGrid');
...
'Callback',{@mag_synthetic_uiCB,h1,'check_RTP_CB'},...
'String','Compute RTP too',...
'Style','checkbox',...
'TooltipString','Compute also an Reduced To the Pole anomaly too',...
'Tag','check_RTP');

uicontrol('Parent',h1,'Position',[220 18 80 21],...
'Callback',{@mag_synthetic_uiCB,h1,'push_run_CB'},...
'FontSize',9,...
'FontWeight','bold',...
'String','Run',...
'Tag','push_run');

function mag_synthetic_uiCB(hObject, eventdata, h1, callback_name)
