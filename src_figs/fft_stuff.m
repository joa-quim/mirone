...
% $Id: fft_stuff.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@fft_stuff_uiCB,h1,'edit_Grid1_CB'},...
...
'Callback',{@fft_stuff_uiCB,h1,'push_Grid1_CB'},...
'Tag','push_Grid1');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@fft_stuff_uiCB,h1,'edit_Grid2_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@fft_stuff_uiCB,h1,'push_Grid2_CB'},...
'Tag','push_Grid2');
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@fft_stuff_uiCB,h1,'edit_Ncols_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@fft_stuff_uiCB,h1,'edit_derivative_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@fft_stuff_uiCB,h1,'edit_dirDerivative_CB'},...
...
'Callback',{@fft_stuff_uiCB,h1,'push_goUDcont_CB'},...
'String','Go',...
'Tag','push_goUDcont');

uicontrol('Parent',h1, 'Position',[168 43 31 21],...
'Callback',{@fft_stuff_uiCB3,h1,[],'push_goDerivative_CB'},...
'String','Go',...
'Tag','push_goDerivative');

uicontrol('Parent',h1, 'Position',[168 13 31 21],...
'Callback',{@fft_stuff_uiCB,h1,'push_goDirDerivative_CB'},...
'String','Go',...
