...
'Call',{@multiscale_uiCB,h1,'popup_algo_CB'},...
...
'BackgroundColor',[1 1 1],...
'Call',{@multiscale_uiCB,h1,'edit_nWin_CB'},...
'String','3',...
'Style','edit',...
...
'Call',{@multiscale_uiCB,h1,'push_OK_CB'},...
'FontName','Helvetica', 'FontSize',9,...
'String','OK', 'Tag','push_OK');

uicontrol('Parent',h1, 'Position',[305 9 66 21],...
'Call',{@multiscale_uiCB,h1,'push_cancel_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','Cancel',...
'Tag','push_cancel');

function multiscale_uiCB(hObject, eventdata, h1, callback_name)
