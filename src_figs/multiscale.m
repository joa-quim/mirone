...
% $Id: multiscale.m 10217 2018-01-24 21:33:46Z j $
...
'String','3',...
'Style','edit',...
'Tooltip','Width of the rectangular neighborhood (MUST be an odd number)',...
'Tag','edit_nWin');
...
'Style','text',...
'TooltipString','Width of the rectangular neighborhood (MUST be an odd number)');
