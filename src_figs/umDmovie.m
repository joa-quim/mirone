...
% M-File changed by desGUIDE  
    ...
    umDmovie_LayoutFcn(hObject,handles);
    handles = guihandles(hObject);
...
function edit_profile_Callback(hObject, eventdata, handles)
    fname = get(hObject,'String');
    push_profile_Callback([], [], handles, fname)

% -----------------------------------------------------------------------------------------
function push_profile_Callback(hObject, eventdata, handles, opt)
...
function umDmovie_LayoutFcn(h1,handles);
...
'Callback',{@umDmovie_uicallback,h1,'edit_profile_Callback'},...
'HorizontalAlignment','left',...
'Position',[10 289 200 21],...
'Style','edit',...
'TooltipString','Name of a x,y file where to build the transect movie ',...
'Tag','edit_profile');

uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_profile_Callback'},...
'Position',[210 289 21 21],...
'TooltipString','Browse for a profile file name',...
'Tag','push_profile');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_namesList_Callback'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_namesList_Callback'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'listbox1_Callback'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_singleWater_Callback'},...
'HorizontalAlignment','left',...
'Position',[20 15 180 21],...
'Style','edit',...
'TooltipString','Name of one water level grid for test testing purposes',...
'Tag','edit_singleWater');

uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_singleWater_Callback'},...
'Position',[200 15 21 21],...
'Tag','push_singleWater');

uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_clearTestBat_Callback'},...
'FontName','Helvetica',...
'FontSize',7,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_movieName_Callback'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_movieName_Callback'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_batGrid_Callback'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_batGrid_Callback'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_imgHeight_Callback'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_imgWidth_Callback'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@umDmovie_uicallback,h1,'edit_fps_Callback'},...
'Position',[400 77 30 18],...
'String','5',...
'Style','edit',...
'TooltipString','Frames per second (ignored in MPEG)',...
'Tag','edit_fps');

uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'push_stop_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
...
uicontrol('Parent',h1,...
'Callback',{@umDmovie_uicallback,h1,'pushbutton_OK_Callback'},...
'FontName','Helvetica',...
'FontSize',10,...
...
'Callback',{@umDmovie_uicallback,h1,'radio_mpg_Callback'},...
'FontName','Helvetica',...
...
function umDmovie_uicallback(hObject, eventdata, h1, callback_name)
