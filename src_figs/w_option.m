...
'Callback',{@main_uiCB,h1,'popup_LineThickness_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'popup_LineColor_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'popup_LineType_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_LineThickness_pt_CB'},...
'CData',[],...
...
'Callback',{@main_uiCB,h1,'edit_LineColor_R_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@main_uiCB,h1,'edit_LineColor_G_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@main_uiCB,h1,'edit_LineColor_B_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'pushbutton_CustomColor_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'pushbutton_Example_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'pushbutton_OK_CB'},...
'Position',[318 10 66 23],...
'String','OK',...
'Tag','pushbutton_OK');

uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'pushbutton_Cancel_CB'},...
