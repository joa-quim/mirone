...
% $Id: vitrinite.m 10217 2018-01-24 21:33:46Z j $
...
'Callback',{@main_uiCB,h1,'popup_markersImgs_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_callibrate_CB'},...
'FontSize',9,...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_getTiePoint_CB'},...
'FontSize',9,...
...
uicontrol('Parent',h1,...
'Callback',{@main_uiCB,h1,'push_getAvgReflec_CB'},...
'Enable','inactive',...
'FontSize',9,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@main_uiCB,h1,'edit_reflectance_CB'},...
