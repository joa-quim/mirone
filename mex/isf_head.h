...
int nullify_data_type(char *data_type, char *subtype,
						char *data_format, char *subformat);
...
int nullify_netmag(char *magtype, char* magind, float* mag,
...
int nullify_phase_min(float *timeoffset, float *azoffset,
                    float *slowoffset, float *ampoffset, float *peroffset,
                    float *magoffset);

int nullify_phase_max(float *timeoffset, float *azoffset,
                    float *slowoffset, float *ampoffset, float *peroffset,
                    float *magoffset);

int nullify_phase_correc(float *timecorr, float *azcorr,float *slowcorr, 
						float *ampcorr, float *percorr,float *magcorr);
...
int read_data_type(char *line, char *data_type, char *subtype,
                   char *data_format,char *subformat);
...
int read_origin_param(char *line, char **param, char **value, char **error,
					  int *n);
...
int read_phase_measure(char *line, char **param, char **value, char **error,
						int *n);
