 ...
 *
 **********************************************************************/
void handle_nc_get_att ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *the_op ) {
 ...
 *
 **********************************************************************/
void handle_nc_get_var_x ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *nc_op ) {
 ...
 *
 **********************************************************************/
void handle_nc_get_varm_x ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *the_op ) {
 ...
 *
 **********************************************************************/
void handle_nc_put_att   ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *the_op ) {
 ...
 *
 **********************************************************************/
void handle_nc_put_var_x ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *nc_op ) {
    ...
    switch ( opcode ) {
         ...
         * */
        case PUT_VARS_DOUBLE:
            status = nc_put_vars_double ( ncid, varid, nc_start_coord, 
                            nc_count_coord, nc_stride_coord, (double *)data_buffer );
            break;

        case PUT_VARS_FLOAT:
            status = nc_put_vars_float ( ncid, varid, nc_start_coord, 
                            nc_count_coord, nc_stride_coord, (float *)data_buffer );
            break;

        case PUT_VARS_INT:
            status = nc_put_vars_int ( ncid, varid, nc_start_coord, 
                            nc_count_coord, nc_stride_coord, (int *)data_buffer );
            break;
        ...
        case PUT_VARS_SCHAR:
            status = nc_put_vars_schar ( ncid, varid, nc_start_coord, 
                            nc_count_coord, nc_stride_coord, (signed char *)data_buffer );
            break;

        case PUT_VARS_UCHAR:
            status = nc_put_vars_uchar ( ncid, varid, nc_start_coord, 
                            nc_count_coord, nc_stride_coord, (unsigned char *)data_buffer );
            break;
 ...
 *
 **********************************************************************/
void handle_nc_put_varm_x ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *nc_op ) {
