 ...
 *
 **********************************************************************/
void handle_nc_def_var_deflate ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *nc_op ) {
 ...
 *
 **********************************************************************/
void handle_nc_inq_var_deflate ( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[], op *nc_op ) {
