	...
	int            idx ) 
{
	...
	char *error_fmt = { "argument in position %d must be either character or numeric, operation \"%s\"\n" };
 ...
 *
 *********************************************************************/
void check_mode_argument_type ( const mxArray *mode_mx[], char *opname, int idx ) {
...
void check_numeric_argument_type ( const mxArray *mx[], char *opname, int idx ) {
	...
	char *error_fmt = { "argument in position %d must be numeric, operation \"%s\"\n" };
