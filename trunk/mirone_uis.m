...
uimenu('Parent',h114,'Call','datasets_funs(''CoastLines'',guidata(gcbo),''c'')',...
'Label','Crude resolution','Tag','CoastLineCrude');

uimenu('Parent',h114,'Call','datasets_funs(''CoastLines'',guidata(gcbo),''l'')',...
'Label','Low resolution','Tag','CoastLineLow');

uimenu('Parent',h114,'Call','datasets_funs(''CoastLines'',guidata(gcbo),''i'')',...
'Label','Intermediate resolution','Tag','CoastLineInterm');

uimenu('Parent',h114,'Call','datasets_funs(''CoastLines'',guidata(gcbo),''h'')',...
'Label','High resolution','Tag','CoastLineHigh');

uimenu('Parent',h114,'Call','datasets_funs(''CoastLines'',guidata(gcbo),''f'')',...
