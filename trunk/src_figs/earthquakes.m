...
uicontrol('Parent',h1,...
'Call',{@earthquakes_uiCB,h1,'push_externalFile_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_StartYear_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_StartMonth_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_StartDay_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_EndYear_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_EndMonth_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_EndDay_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_MagMin_CB'},...
'Position',[71 307 47 21],...
'Style','edit','Tag','edit_MagMin');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_MagMax_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_DepthMin_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@earthquakes_uiCB,h1,'edit_DepthMax_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@earthquakes_uiCB,h1,'push_OK_CB'},...
'Position',[315 10 66 21],...
'String','OK',...
'Tag','push_OK');

function earthquakes_uiCB(hObject, eventdata, h1, callback_name)
