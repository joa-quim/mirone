...
'Call',{@pscoast_options_Mir_uiCB,h1,'popup_Resolution_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_HelpOption_D_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_W_CB'},...
'Position',[20 255 45 23],...
'String','How-to',...
'Tag','push_Option_W');

uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_W_clear_CB'},...
'Position',[70 255 33 23],...
'String','Clear',...
'Tag','push_Option_W_clear');

uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_HelpOption_W_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@pscoast_options_Mir_uiCB,h1,'edit_Option_A_MinArea_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@pscoast_options_Mir_uiCB,h1,'listbox_Option_A_HierarchicalLevel_CB'},...
'Enable','off',...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_A_clear_CB'},...
'Position',[336 253 33 22],...
'String','Clear',...
'Tag','push_Option_A_clear');

uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_HelpOption_A_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_G_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_G_clear_CB'},...
...
uicontrol(...
'Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_HelpOption_G_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_S_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_S_clear_CB'},...
'Position',[205 182 33 22],...
'String','Clear',...
'Tag','push_Option_S_clear');

uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_HelpOption_S_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_C_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Option_C_clear_CB'},...
'Position',[340 182 33 22],...
'String','Clear',...
'Tag','push_Option_C_clear');

uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_HelpOption_C_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@pscoast_options_Mir_uiCB,h1,'popup_Rivers_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_RiversPen_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'checkbox_Option_I_Repeat_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_ClearRivers_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@pscoast_options_Mir_uiCB,h1,'popup_PoliticalBound_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_BoundariesPen_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'checkbox_Option_N_Repeat_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_ClearPoliticalBound_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_Cancel_CB'},...
'Position',[330 38 81 29],...
'String','Cancel',...
'Tag','push_Cancel');

uicontrol('Parent',h1,...
'Call',{@pscoast_options_Mir_uiCB,h1,'push_OK_CB'},...
...
function pscoast_options_Mir_uiCB(hObject, eventdata, h1, callback_name)
