...
function push_palette_Callback(hObject, eventdata, handles)
    ...
    if (~isempty(cmap))
        ...
        set(handles.checkbox_resetCmaps,'Vis','on')
        guidata(handles.figure1,handles)
    end
...
% -----------------------------------------------------------------------------------------
function checkbox_resetCmaps_Callback(hObject, eventdata, handles)
...
uicontrol('Parent',h1,...
'Callback',{@tsunamovie_uicallback,h1,'push_palette_Callback'},...
