...
'Call',{@grdsample_mir_uiCB,h1,'edit_x_min_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_x_inc_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_y_inc_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_Ncols_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'edit_Nrows_CB'},...
'HorizontalAlignment','center',...
...
'Call',{@grdsample_mir_uiCB,h1,'push_Help_R_F_T_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdsample_mir_uiCB,h1,'popup_BoundaryCondition_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@grdsample_mir_uiCB,h1,'push_Help_L_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'Call',{@grdsample_mir_uiCB,h1,'push_OK_CB'},...
'Position',[365 8 66 21],...
'String','OK',...
'Tag','push_OK');

function grdsample_mir_uiCB(hObject, eventdata, h1, callback_name)
