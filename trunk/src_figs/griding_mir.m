...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'checkbox_Option_H_CB'},...
...
'Callback',{@griding_mir_uiCB,h1,'edit_nHeaders_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'popup_binInput_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_binary_ncolumnIn_CB'},...
'HorizontalAlignment','left',...
...
'Callback',{@griding_mir_uiCB,h1,'push_Help_H_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_InputFile_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'push_InputFile_CB'},...
'Position',[350 285 23 23],...
'Tag','push_InputFile');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_x_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_x_inc_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_Ncols_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_y_inc_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_Nrows_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'checkbox_ToggleXY_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'checkbox_Option_F_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'push_Help_R_F_toggle_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'edit_S1_Neighbor_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'popup_S2_Neighbor_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'push_Help_S_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@griding_mir_uiCB,h1,'popup_GridMethod_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'push_Grid_Options_CB'},...
...
uimenu('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'Menu_Help_CB'},...
'Label','Help',...
'Tag','Menu_Help');
...
uimenu('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'about_window_CB'},...
'Label','About',...
'Tag','about_window');
...
uicontrol('Parent',h1,...
'Callback',{@griding_mir_uiCB,h1,'push_OK_CB'},...
'FontWeight','bold',...
'Position',[270 7 111 21],...
'String','Compute',...
'Tag','push_OK');

function griding_mir_uiCB(hObject, eventdata, h1, callback_name)
