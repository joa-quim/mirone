...
time = clock;
set(handles.edit_DateYY,'String',num2str(time(1)))
set(handles.edit_DateMM,'String',num2str(time(2)))
set(handles.edit_DateDD,'String',num2str(time(3)))

yd = dec_year;
set(handles.edit_DateDec,'String',num2str(yd,'%.3f'))
...
set(handles.edit_Xmin,'String','-180')
set(handles.edit_Xmax,'String','180')
...
image([-180 180],[-90 90],handles.w_map);   set(handles.axes1,'XDir','normal','YDir','normal');

% Fish the new text handles
handles.h_txt_F = findobj(hObject,'Tag','text_FnT','Style','text');
handles.h_txt_X = findobj(hObject,'Tag','text_XnT','Style','text');
handles.h_txt_Y = findobj(hObject,'Tag','text_YnT','Style','text');
handles.h_txt_Z = findobj(hObject,'Tag','text_ZnT','Style','text');
handles.h_txt_H = findobj(hObject,'Tag','text_HnT','Style','text');
handles.h_txt_D = findobj(hObject,'Tag','text_Ddeg','Style','text');
handles.h_txt_I = findobj(hObject,'Tag','text_Ideg','Style','text');
%set(findobj(hObject,'Tag','text_F','Style','text'),'FontSize',10)
% Fill the various mag field texts
set(handles.h_txt_F,'String',[num2str(out(1),'%.0f') '  nT'],'FontSize',10)
set(handles.h_txt_H,'String',[num2str(out(2),'%.0f') '  nT'],'FontSize',10)
set(handles.h_txt_X,'String',[num2str(out(3),'%.0f') '  nT'],'FontSize',10)
set(handles.h_txt_Y,'String',[num2str(out(4),'%.0f') '  nT'],'FontSize',10)
set(handles.h_txt_Z,'String',[num2str(out(5),'%.0f') '  nT'],'FontSize',10)
set(handles.h_txt_D,'String',[num2str(out(6),'%.1f') ' º'],'FontSize',10)
set(handles.h_txt_I,'String',[num2str(out(7),'%.1f') ' º'],'FontSize',10)

set(hObject,'WindowButtonDownFcn',{@wbd,handles});

% Choose default command line output for igrf_options_export
handles.output = hObject;
guidata(hObject, handles);

% UIWAIT makes igrf_options_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);

set(hObject,'Visible','on');
% NOTE: If you make uiwait active you have also to uncomment the next three lines
% handles = guidata(hObject);
% out = igrf_options_OutputFcn(hObject, [], handles);
% varargout{1} = out;

% --- Outputs from this function are returned to the command line.
function varargout = igrf_options_OutputFcn(hObject, eventdata, handles)
...
if (xlim(1) <= Pt(1,1) & Pt(1,1) <= xlim(2) & ylim(1) <= Pt(1,2) & Pt(1,2) <= ylim(2))
    set(handles.edit_LonDec,'String',num2str(Pt(1,1),'%.3f'))
    set(handles.edit_LatDec,'String',num2str(Pt(1,2),'%.3f'))
    dms = dec2deg(Pt(1,1),'opt');       % Convert longitude decimal degrees in deg,min,sec
    set(handles.edit_LonDeg,'String',num2str(dms(1),'%.0f'))
    set(handles.edit_LonMin,'String',num2str(dms(2),'%.0f'))
    set(handles.edit_LonSec,'String',num2str(dms(3),'%.2f'))
    dms = dec2deg(Pt(1,2),'opt');       % Convert latitude decimal degrees in deg,min,sec
    set(handles.edit_LatDeg,'String',num2str(dms(1),'%.0f'))
    set(handles.edit_LatMin,'String',num2str(dms(2),'%.0f'))
    set(handles.edit_LatSec,'String',num2str(dms(3),'%.2f'))
...
if (isempty(get(hObject,'String'))),    set(hObject,'String','37'); return; end
...
set(handles.edit_LatDec,'String',num2str(lat,'%.4f'))
lon = str2double(get(handles.edit_LonDec,'String'));
elev = str2double(get(handles.edit_Elev,'String'));
date = str2double(get(handles.edit_DateDec,'String'));
...
if (isempty(get(hObject,'String'))),    set(hObject,'String','-8'); return; end
...
set(handles.edit_LonDec,'String',num2str(lon,'%.4f'))
lat = str2double(get(handles.edit_LatDec,'String'));
elev = str2double(get(handles.edit_Elev,'String'));
date = str2double(get(handles.edit_DateDec,'String'));
out = igrf_m(lon, lat, elev, date);
...
set(handles.edit_LatDec,'String',num2str(lon,'%.4f'))
lat = str2double(get(handles.edit_LatDec,'String'));
elev = str2double(get(handles.edit_Elev,'String'));
date = str2double(get(handles.edit_DateDec,'String'));
out = igrf_m(lon, lat, elev, date);
...
if (isempty(xx)),    set(hObject,'String','0'); return; end
lon = str2double(get(handles.edit_LonDec,'String'));
lat = str2double(get(handles.edit_LatDec,'String'));
elev = str2double(xx);
date = str2double(get(handles.edit_DateDec,'String'));
...
if (isempty(get(hObject,'String'))),    set(hObject,'String','1'); return; end
...
set(handles.edit_DateDec,'String',num2str(yd))
date = str2double(get(handles.edit_DateDec,'String'));
lat = str2double(get(handles.edit_LatDec,'String'));
lon = str2double(get(handles.edit_LonDec,'String'));
elev = str2double(get(handles.edit_Elev,'String'));
...
if (isempty(get(hObject,'String'))),    set(hObject,'String','2004'); return; end
...
if (isempty(get(hObject,'String'))),    set(hObject,'String','2005'); return; end
date = str2double(get(hObject,'String'));
...
if (xx <= 0 | isnan(xx))
    ...
    set(hObject,'String',num2str(fix(xx)))      % Prevent any "jokes"
end
...
if (headerlines)        % Update headers info in checkbox and editbox
    ...
    set(handles.edit_nHeaders,'String',num2str(headerlines),'Enable','on')
end
...
% Nothing to do here. The pushbutton_ComputeFile will look for the filename
...
% -------------------------------------------------------------------------------------------------
function popup_FieldComponent_Callback(hObject, eventdata, handles)
% Hints: contents = get(hObject,'String') returns popup_FieldComponent contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popup_FieldComponent
...
% Fill the various mag field texts
set(handles.h_txt_F,'String',[num2str(out(1),'%.0f') '  nT'])
set(handles.h_txt_H,'String',[num2str(out(2),'%.0f') '  nT'])
set(handles.h_txt_X,'String',[num2str(out(3),'%.0f') '  nT'])
set(handles.h_txt_Y,'String',[num2str(out(4),'%.0f') '  nT'])
set(handles.h_txt_Z,'String',[num2str(out(5),'%.0f') '  nT'])
set(handles.h_txt_D,'String',[num2str(out(6),'%.1f') ' º'])
set(handles.h_txt_I,'String',[num2str(out(7),'%.1f') ' º'])
...
'FontSize',9,...
'Position',[10 224 461 75],...
'String',{  '' },...
'Style','frame',...
'Tag','frame4');

h3 = uicontrol('Parent',h1,...
'Position',[10 319 461 111],...
'String',{  '' },...
'Style','frame',...
'Tag','frame3');
...
'Enable','inactive',...
'Position',[10 13 461 93],...
'String',{  '' },...
'Style','frame',...
'Tag','frame1');

h48 = uicontrol('Parent',h1,...
...
'BackgroundColor',[1 1 1],...
'Callback',{@igrf_options_uicallback,h1,'edit_OutputFile_Callback'},...
'HorizontalAlignment','left',...
...
h69 = uicontrol('Parent',h1,...
'Enable','inactive',...
'Position',[169 186 41 13],...
'String','Max',...
'Style','text',...
'Tag','text35');
...
'Enable','inactive',...
'Position',[91 187 41 13],...
'String','Min',...
'Style','text',...
'Tag','text36');

h71 = uicontrol('Parent',h1,...
'Enable','inactive',...
...
h72 = uicontrol('Parent',h1,...
'CData',[],...
'Enable','inactive',...
'Position',[302 187 51 13],...
'String','# of lines',...
'Style','text',...
'Tag','text38',...
'UserData',[]);

h73 = uicontrol('Parent',h1,...
'Enable','inactive',...
'Position',[27 198 110 15],...
'String','Griding Line Geometry',...
'Style','text',...
'Tag','text39');

h74 = uicontrol('Parent',h1,...
...
h75 = uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@igrf_options_uicallback,h1,'popup_FieldComponent_Callback'},...
...
h77 = uicontrol('Parent',h1,...
'Enable','inactive',...
'Position',[31 290 65 15],...
'String','Point values',...
'Style','text',...
'Tag','text40');

h78 = uicontrol('Parent',h1,...
'Enable','inactive',...
'Position',[30 422 51 15],...
'String','Location',...
'Style','text',...
'Tag','text41');
...
'Position',[0.495260663507109 -0.106635071090047 1.00005459937205],...
...
'Color',[0 0 0],...
'HorizontalAlignment','center',...
'Position',[-0.130331753554502 0.495260663507109 1.00005459937205],...
'Rotation',90,...
