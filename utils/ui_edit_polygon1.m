...
%
%  When VARARGIN is a handle to a rectangle line three things may happen:
...
%   2. The rectangle is described in clockwise way with origin at lower left point
%       - The editing deforms the rectangular.
%   3. The remain cases are not forseen. Unexpected behaviour.
%
...
if (s.is_rect & s.quip_rect & ~s.is_patch)                % We are dealing with a line rectangle
    if (s.vert_index == 1)
