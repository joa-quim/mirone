...
% --------------------------------------------------------------------
	...
	if (handles.fault_in || ~getappdata(handles.hCallingFig,'esDourada'))
...
% ------------------------------------------------------------------------------------
function push_focal_Callback(hObject, eventdata, handles)
...
uicontrol('Parent',h1,...
'Callback',{@deform_mansinha_uicallback,h1,'push_focal_Callback'},...
'Position',[380 51 29 29],...
'TooltipString','Show focal mechanism',...
'Tag','push_focal');

uicontrol('Parent',h1,...
'Callback',{@deform_mansinha_uicallback,h1,'push_compute_Callback'},...
'FontWeight','bold',...
