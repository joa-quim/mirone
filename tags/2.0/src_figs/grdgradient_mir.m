...
function check_direction_grad_CB(hObject, handles)
	if get(hObject,'Value')
		...
		set(handles.check_direction_grad,'Enable','on');	% Can be called also by check_magnitude
	else
		set(handles.listbox_azim1,'Value',1);		set(handles.listbox_azim2,'Value',1);
		set(handles.listbox_azim1,'Enable','on');	set(handles.listbox_azim2,'Enable','on');
		set(handles.check_magnitude_grad,'Value',0);
...
uicontrol('Parent',h1, 'Position',[270 110 210 81],...
'Style','frame',...
'Tag','frame1');

uicontrol('Parent',h1, 'Position',[10 110 231 81],...
'Style','frame',...
'Tag','frame2');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'listbox_azim1_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'listbox_azim2_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@grdgradient_mir_uiCB,h1,'push_Help_Azim_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Call',{@grdgradient_mir_uiCB,h1,'check_direction_grad_CB'},...
'Position',[279 146 125 17],...
'String','Gradient direction',...
'Style','checkbox',...
'Tooltip','Find the direction of the gradient of the data',...
'Tag','check_direction_grad');

uicontrol('Parent',h1, 'Position',[279 168 180 15],...
'Call',{@grdgradient_mir_uiCB,h1,'check_direction_grad_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@grdgradient_mir_uiCB,h1,'push_Help_direction_grad_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'popup_BoundaryCondition_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@grdgradient_mir_uiCB,h1,'push_Help_L_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
uicontrol('Parent',h1,...
'Call',{@grdgradient_mir_uiCB,h1,'push_OK_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'popup_normalization_CB'},...
...
'Tag','popup_normalization');
 ...
 uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'edit_normalization_amp_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'edit_normalization_sigma_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@grdgradient_mir_uiCB,h1,'edit_normalization_offset_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@grdgradient_mir_uiCB,h1,'push_Help_N_grad_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
...
function grdgradient_mir_uiCB(hObject, event, h1, callback_name)
