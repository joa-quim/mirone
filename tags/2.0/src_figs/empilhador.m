...
'Call',{@l2_choices_uiCB,h1,'radio_sensor_CB'},...
'FontName','Helvetica',...
...
'Call',{@l2_choices_uiCB,h1,'radio_georef_CB'},...
'FontName','Helvetica',...
...
'Call',{@l2_choices_uiCB,h1,'radio_interpNear_CB'},...
'Enable','off',...
'FontName','Helvetica',...
'String','Nearneighbor',...
'Style','radiobutton',...
...
'Call',{@l2_choices_uiCB,h1,'radio_interpMin_CB'},...
'Enable','off',...
'FontName','Helvetica',...
...
'Call',{@l2_choices_uiCB,h1,'check_landMask_CB'},...
'Enable','off',...
...
'Call',{@l2_choices_uiCB,h1,'push_OK_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
'String','OK',...
'Tag','push_OK');

function l2_choices_uiCB(hObject, eventdata, h1, callback_name)
