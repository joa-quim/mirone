...
if nargsin
    ...
    error('DATE2JD: Wrong number of arguments');
end
[year, month, day, hour, minute, second] = deal(argv{:});

% The following algorithm is a modified version of the one found in the Calendar FAQ.
a = floor((14 - month)/12);
y = year + 4800 - a;
m = month + 12*a - 3;
...
jd = day + floor((153*m + 2)/5) ...
    ...
    + ( second + 60*minute + 3600*(hour - 0) )/86400;