...
uicontrol('Parent',h1,...
'Call',@thresholdit_uiCB,...
'Position',[530 376 141 23],...
'String','Isodata method',...
'Tag','push_isodata');

uicontrol('Parent',h1,...
'Call',@thresholdit_uiCB,...
'Position',[530 346 141 23],...
'String','Triangle method',...
'Tag','push_triang');

uicontrol('Parent',h1,...
'Call',@thresholdit_uiCB,...
'Position',[531 268 120 19],...
