...
% -----------------------------------------------------------------------------------------
function togglebutton_zoom_OnOff_CB(hObject, eventdata, handles)
	if (get(hObject,'Value')),	zoom_j('on');
	else						zoom_j('off');
	end

% -----------------------------------------------------------------------------------------
function pushbutton_draw_rectangle_CB(hObject, eventdata, handles)
...
function pushbutton_change_dir_CB(hObject, eventdata, handles)
	...
	if ~isempty(work_dir)
		...
		set(handles.popup_directory_list,'String',handles.last_directories)
		guidata(hObject, handles);
		popup_directory_list_CB(hObject, eventdata, handles, work_dir)
	end

% -----------------------------------------------------------------------------------------
function pushbutton_help_CB(hObject, eventdata, handles)
...
uicontrol('Parent',h1,...
'Callback',{@srtm_tool_uicallback,h1,'togglebutton_zoom_OnOff_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@srtm_tool_uicallback,h1,'pushbutton_draw_rectangle_CB'},...
...
'Callback',{@srtm_tool_uicallback4,h1,[],'popup_directory_list_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@srtm_tool_uicallback,h1,'pushbutton_help_CB'},...
'Position',[615 32 66 21],...
'String','Help',...
'Tag','pushbutton_help');

uicontrol('Parent',h1,...
'Callback',{@srtm_tool_uicallback,h1,'pushbutton_OK_CB'},...
'FontSize',9,...
'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Callback',{@srtm_tool_uicallback,h1,'pushbutton_change_dir_CB'},...
'FontSize',10,...
'FontWeight','bold',...
