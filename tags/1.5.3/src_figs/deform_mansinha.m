...
function checkbox_SCC_CB(hObject, eventdata, handles)
    ...
    if (get(hObject,'Value'))
        ...
        if (handles.restoreOldPlane)
            ...
            set(handles.checkbox_hideFaultPlanes,'Val',1)
        end
...
% -----------------------------------------------------------------------------------------
function edit_SCC_CB(hObject, eventdata, handles)
    ...
    if (get(handles.checkbox_SCC,'Val'))    % We are already on the Fatias building mode. So rebuild them
        do_scc(handles);
    end
...
function stripes = do_scc(handles)
    ...
    if (~get(handles.checkbox_hideFaultPlanes,'Val'))
        set(handles.checkbox_hideFaultPlanes,'Val',1)
        checkbox_hideFaultPlanes_CB(handles.checkbox_hideFaultPlanes, [], handles)
        set(handles.checkbox_hideFaultPlanes,'Val',0)
    end
    ...
    if (get(handles.checkbox_hideFaultPlanes,'Val')),        stripeVis = 'off';    end
    ...
    for (i=1:handles.n_faults)
        ...
        uimenu(cmenuHand(i), 'Label', 'Delete', 'Callback',{@deleteFatias,handles});
        uimenu(cmenuHand(i), 'Label', 'Show slip profile', 'Callback',{@showFatias,handles});
    end
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_FaultWidth_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_FaultDip_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_FaultDepth_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_FaultTopDepth_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'popup_segment_CB'},...
...
uicontrol('Parent',h1,'Position',[320 126 211 131],'Style','frame','Tag','frame2');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_DislocStrike_CB'},...
'Position',[330 213 51 21],...
'Style','edit',...
'Tag','edit_DislocStrike');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_DislocRake_CB'},...
'Position',[400 213 51 21],...
'Style','edit',...
'TooltipString','Displacement angle anti-clockwise from horizontal',...
'Tag','edit_DislocRake');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_DislocSlip_CB'},...
...
uicontrol('Parent',h1,'Enable','inactive','Position',[10 11 350 93],...
'Style','frame','Tag','frame3');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_x_min_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_x_inc_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_Ncols_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_y_inc_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_Nrows_CB'},...
...
'Callback',{@deform_mansinha_uicallback,h1,'pushbutton_Help_R_CB'},...
'FontWeight','bold',...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'popup_fault_CB'},...
...
'TooltipString','Use variable slip',...
'Style','checkbox','Tag','checkbox_SCC');

uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_SCC_CB'},...
'Position',[450 135 31 21],...
'Style','edit','String','20',...
'TooltipString','Number of discretization slices',...
'Tag','edit_nSlices');
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'edit_qValue_CB'},...
'Position',[485 135 40 21],...
'Style','edit','String','0.3',...
'TooltipString','Slip skewness control (0 < q < 1)',...
'Tag','edit_qValue');
...
'Callback',{@deform_mansinha_uicallback,h1,'edit_mu_CB'},...
...
uicontrol('Parent',h1,'BackgroundColor',[1 1 1],...
'Callback',{@deform_mansinha_uicallback,h1,'popup_GridCoords_CB'},...
...
uicontrol('Parent',h1,...
'Callback',{@deform_mansinha_uicallback,h1,'push_focal_CB'},...
'Position',[380 51 29 29],...
'TooltipString','Show focal mechanism',...
'Tag','push_focal');

uicontrol('Parent',h1,...
'Callback',{@deform_mansinha_uicallback,h1,'push_compute_CB'},...
'FontWeight','bold',...
