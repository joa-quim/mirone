...
% --------------------------------------------------------------------
	...
	new_frame3D(hObject, handles.text2, handles.frame2)
	%------------- END Pro look (3D) -------------------------------------------------------
...
% --------------------------------------------------------------------
function radio_active_CB(hObject, eventdata, handles)
	if (~get(hObject,'Val')),	set(hObject,'Val',1),	return,		end
	set([handles.radio_stable handles.radio_guess],'Value', 0)

% --------------------------------------------------------------------
function radio_stable_CB(hObject, eventdata, handles)
	if (~get(hObject,'Val')),	set(hObject,'Val',1),	return,		end
	set([handles.radio_active handles.radio_guess],'Value', 0)

% --------------------------------------------------------------------
function radio_guess_CB(hObject, eventdata, handles)
	if (~get(hObject,'Val')),	set(hObject,'Val',1),	return,		end
	set([handles.radio_active handles.radio_stable],'Value', 0)

% --------------------------------------------------------------------
function edit_mag_CB(hObject, eventdata, handles)
...
uicontrol('Parent',h1, 'Position',[180 61 240 79], 'Style','frame', 'Tag','frame2');
uicontrol('Parent',h1, 'Position',[7 61 163 79], 'Style','frame', 'Tag','frame1');

uicontrol('Parent',h1, 'Position',[14 112 66 15],...
'FontName','Helvetica',...
'String','Intensity',...
'Style','checkbox',...
'TooltipString','Calculate Intensity map',...
'Value',1,...
'Tag','check_INT');
...
'Style','checkbox',...
'TooltipString','Calculate PGA map',...
'Tag','check_PGA');
...
'Style','checkbox',...
'TooltipString','Calculate PGV map',...
'Tag','check_PGV');
...
'Callback',{@ground_motion_uicallback,h1,'radio_active_CB'},...
'FontName','Helvetica',...
...
'Callback',{@ground_motion_uicallback,h1,'radio_stable_CB'},...
'FontName','Helvetica',...
...
'Callback',{@ground_motion_uicallback,h1,'radio_guess_CB'},...
'FontName','Helvetica',...
'String','Let me guess',...
'Style','radiobutton',...
'TooltipString','I''ll do the guessing based on the average slope',...
'Value',1,...
'Tag','radio_guess');
...
'BackgroundColor',[1 1 1],...
'Callback',{@ground_motion_uicallback,h1,'edit_mag_CB'},...
'String','7',...
'Style','edit',...
'TooltipString','Event Magnitude',...
'Tag','edit_mag');
...
'Callback',{@ground_motion_uicallback,h1,'push_OK_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
'FontWeight','bold',...
'String','OK',...
...
function ground_motion_uicallback(hObject, eventdata, h1, callback_name)
