...
uicontrol('Parent',h1,...
'Callback',{@grdlandmask_win_uicallback,h1,'push_cancel_Callback'},...
'FontName','Helvetica',...
'FontSize',9,...
'Position',[371 7 60 23],...
'String','Cancel',...
'Tag','push_cancel');
