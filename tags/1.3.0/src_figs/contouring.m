...
uicontrol('Parent',h1, 'Position',[21 236 75 17],...
'String','Plot Labels',...
'Style','checkbox',...
...
uicontrol('Parent',h1, 'Position',[20 206 241 23],...
...
uicontrol('Parent',h1, 'Position',[30 55 221 23],...
...
uicontrol('Parent',h1, 'Position',[200 142 51 23],...
...
uicontrol('Parent',h1, 'Position',[290 76 145 23],...
...
uicontrol('Parent',h1, 'Position',[290 47 145 23],...
...
uicontrol('Parent',h1, 'Position',[263 6 91 23],...
'Callback',{@contouring_uicallback,h1,'pushbutton_Apply_Callback'},...
'String','Apply',...
'Tag','pushbutton_Apply');

uicontrol('Parent',h1, 'Position',[363 6 81 23],...
