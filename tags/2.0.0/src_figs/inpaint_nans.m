...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_paintAll_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_paintSmall_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_surface_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_bicubic_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_bilinear_CB'},...
'FontName','Helvetica',...
...
% uicontrol('Parent',h1,...
% 'Call',{@inpaint_nans_uiCB,h1,'push_help_CB'},...
% 'FontName','Helvetica',...
% 'FontSize',11,...
% 'FontWeight','bold',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_inPlace_CB'},...
'FontName','Helvetica',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'radio_newWin_CB'},...
'FontName','Helvetica',...
'Position',[11 6 86 16],...
'String','New window',...
'Style','radiobutton',...
...
uicontrol('Parent',h1,...
'Call',{@inpaint_nans_uiCB,h1,'push_OK_CB'},...
'FontName','Helvetica',...
'FontSize',9,...
...
function inpaint_nans_uiCB(hObject, eventdata, h1, callback_name)
