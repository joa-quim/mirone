...
'Call',{@meca_studio_uiCB,h1,'slider_strike_CB'},...
'Max',360,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@meca_studio_uiCB,h1,'edit_strike_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@meca_studio_uiCB,h1,'slider_dip_CB'},...
'Max',90,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@meca_studio_uiCB,h1,'edit_dip_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@meca_studio_uiCB,h1,'slider_rake_CB'},...
'Max',180,...
'Min',-180,...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@meca_studio_uiCB,h1,'edit_rake_CB'},...
...
uicontrol('Parent',h1,...
'Call',{@meca_studio_uiCB,h1,'push_GMTcomm_CB'},...
'FontName','Helvetica',...
...
function meca_studio_uiCB(hObject, eventdata, h1, callback_name)
