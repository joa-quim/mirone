...
if (n_argin >= 1)
    if (ishandle(varargin{1}))              % First argument is an image handle, or ... error
        ...
        if (isa(varargin{1},'uint8') || isa(varargin{1},'logical'))           % First argument is an image array
            ...
            z_min = min(min(handles.OrigGrd));
            z_max = max(max(handles.OrigGrd));
...
function rotatetool_LayoutFcn(h1,handles);
...
h2 = uicontrol('Parent',h1,'Position',[134 40 314 108],...
'Style','frame','Tag','frame3');

h3 = uicontrol('Parent',h1,'Position',[2 4 446 35],...
'Style','frame','Tag','frame2');

h4 = uicontrol('Parent',h1,'Position',[2 40 131 332],...
'Style','frame','Tag','frame1');

h5 = uicontrol('Parent',h1,...
'Callback',{@rotatetool_uicallback,h1,'push_cw90_Callback'},...
...
'Callback',{@rotatetool_uicallback,h1,'push_ccw90_Callback'},...
'Position',[7 309 120 20],...
'String',['Counterclockwise 90' char(186)],...
'Tag','push_ccw90');

h12 = uicontrol('Parent',h1,...
'Callback',{@rotatetool_uicallback,h1,'push_flipLR_Callback'},...
'Position',[7 279 120 20],...
'String','Flip Left/Right',...
'Tag','push_flipLR');

h13 = uicontrol('Parent',h1,...
'Callback',{@rotatetool_uicallback,h1,'push_flipUD_Callback'},...
'Position',[7 249 120 20],...
'String','Flip Up/Down',...
'Tag','push_flipUD');

h14 = uicontrol('Parent',h1,...
'Callback',{@rotatetool_uicallback,h1,'slider_Callback'},...
'Max',180,...
'Min',-180,...
...
'Callback',{@rotatetool_uicallback,h1,'edit_angRot_Callback'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@rotatetool_uicallback,h1,'popup_bboxmenu_Callback'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@rotatetool_uicallback,h1,'popup_interpmenu_Callback'},...
'Position',[210 50 121 22],...
'String',{'Nearest-neighbor'; 'Bilinear'; 'Bicubic'},...
'Style','popupmenu', 'Value',1,...
'Tag','popup_interpmenu');

h18 = uicontrol('Parent',h1,'Position',[144 83 65 15],...
'String','Output Size:','Style','text','Tag','text1');

h19 = uicontrol('Parent',h1,'Position',[144 54 65 15],...
'String','Interpolation:','Style','text','Tag','text2');

h20 = uicontrol('Parent',h1,...
'Callback',{@rotatetool_uicallback,h1,'push_cancel_Callback'},...
'Position',[262 9 60 25],...
'String','Cancel',...
'Tag','push_cancel');

h21 = uicontrol('Parent',h1,...
'Callback',{@rotatetool_uicallback,h1,'push_apply_Callback'},...
'Position',[341 9 100 25],...
...
uicontrol('Parent',h1,'Position',[134 149 314 223],...
'Style','frame','Tag','frame_axes');

function rotatetool_uicallback(hObject, eventdata, h1, callback_name)
