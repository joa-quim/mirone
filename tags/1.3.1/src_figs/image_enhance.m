...
'Position',[16 491 45 15], 'String','Minimum:', 'Style','text');
...
uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[16 472 47 15], 'String','Maximum:', 'Style','text');
...
uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[140 491 45 15], 'String','Minimum:', 'Style','text');
...
uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[140 472 47 15], 'String','Maximum:', 'Style','text');
...
uicontrol('Parent',h1, 'HorizontalAlignment','left',...
'Position',[258 469 35 15], 'String','Center:', 'Style','text');
...
'Position',[367 486 120 17],'String','Match Data Range',...
'Style','radiobutton',...
