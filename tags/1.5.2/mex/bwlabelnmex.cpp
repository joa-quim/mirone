...
mwSize connected_components(mxLogical *BW, double *L, mwSize num_elements, NeighborhoodWalker_T walker) {
    mwSize p;
    mwSize q;
    mwSize next_label = 0;
    mwSize num_sets;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    walker = nhMakeNeighborhoodWalker(nhood, size, num_dims, NH_SKIP_CENTER | NH_SKIP_LEADING);
