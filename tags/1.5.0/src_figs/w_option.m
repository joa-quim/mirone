...
% varargin   command line arguments to w_option (see VARARGIN)
...
w_option_LayoutFcn(hObject,handles);
handles = guihandles(hObject);
...
pushbutton_Example_Callback(hObject, [], handles)
...
out = w_option_OutputFcn(hObject, [], handles);
varargout{1} = out;

% --- Outputs from this function are returned to the command line.
function varargout = w_option_OutputFcn(hObject, eventdata, handles)
...
%-----------------------------------------------------------------
function popup_LineType_Callback(hObject, eventdata, handles)
...
set(handles.edit_ShowCommand, 'String', [handles.command{4:end}]);
pushbutton_Example_Callback(hObject, eventdata, handles)
guidata(hObject, handles);

%----------------------------------------------------------------------------------------------
function popup_LineThickness_Callback(hObject, eventdata, handles)
val = get(hObject,'Value');     str = get(hObject, 'String');
switch str{val};
    case '0.5  pt'
...
%----------------------------------------------------------------------------------------------
function popup_LineColor_Callback(hObject, eventdata, handles)
...
%----------------------------------------------------------------------------------------------
function pushbutton_CustomColor_Callback(hObject, eventdata, handles)
c = uisetcolor;
...
%----------------------------------------------------------------------------------------------
function edit_LineThickness_pt_Callback(hObject, eventdata, handles)
...
% This Callback is never activated, but it's called by other callbacks

%----------------------------------------------------------------------------------------------
function edit_LineColor_R_Callback(hObject, eventdata, handles)
xx = get(hObject,'String');
if str2double(xx) > 255 | str2double(xx) < 0    set(handles.edit_LineColor_R, 'String', '0');     xx = ['0'];   end
...
%----------------------------------------------------------------------------------------------
function edit_LineColor_G_Callback(hObject, eventdata, handles)
xx = get(hObject,'String');
if str2double(xx) > 255 | str2double(xx) < 0    set(handles.edit_LineColor_G, 'String', '0');     xx = ['0'];   end
...
%----------------------------------------------------------------------------------------------
function edit_LineColor_B_Callback(hObject, eventdata, handles)
xx = get(hObject,'String');
if str2double(xx) > 255 | str2double(xx) < 0    set(handles.edit_LineColor_G, 'String', '0');     xx = ['0'];   end
...
%----------------------------------------------------------------------------------------------
function pushbutton_CustomLineType_Callback(hObject, eventdata, handles)

%----------------------------------------------------------------------------------------------
function pushbutton_Example_Callback(hObject, eventdata, handles)
...
function w_option_LayoutFcn(h1,handles);
...
'singleton', 1, ...
'syscolorfig', 1, ...
'lastSavedFile', 'D:\m_gmt\w_option.m', ...
'blocking', 0));

h2 = uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@w_option_uicallback,h1,'popup_LineThickness_Callback'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@w_option_uicallback,h1,'popup_LineColor_Callback'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@w_option_uicallback,h1,'popup_LineType_Callback'},...
...
'BackgroundColor',[1 1 1],...
'Callback',{@w_option_uicallback,h1,'edit_LineThickness_pt_Callback'},...
'CData',[],...
...
'Callback',{@w_option_uicallback,h1,'edit_LineColor_R_Callback'},...
'HorizontalAlignment','left',...
...
'Callback',{@w_option_uicallback,h1,'edit_LineColor_G_Callback'},...
'HorizontalAlignment','left',...
...
'Callback',{@w_option_uicallback,h1,'edit_LineColor_B_Callback'},...
'HorizontalAlignment','left',...
...
'Callback',{@w_option_uicallback,h1,'pushbutton_CustomColor_Callback'},...
'Position',[292 148 22 21],...
'TooltipString','Interactive color selection',...
'Tag','pushbutton_CustomColor');

h10 = uicontrol('Parent',h1,...
'Callback',{@w_option_uicallback,h1,'pushbutton_CustomLineType_Callback'},...
'Enable','off',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@w_option_uicallback,h1,'edit_ShowCommand_Callback'},...
'HorizontalAlignment','left',...
...
'Callback',{@w_option_uicallback,h1,'pushbutton_Example_Callback'},...
...
'Callback',{@w_option_uicallback,h1,'pushbutton_OK_Callback'},...
'Position',[318 10 66 23],...
'String','OK',...
'Tag','pushbutton_OK');

h22 = uicontrol('Parent',h1,...
'Callback',{@w_option_uicallback,h1,'pushbutton_Cancel_Callback'},...
'Position',[318 40 66 23],...
'String','Cancel',...
'Tag','pushbutton_Cancel');

function w_option_uicallback(hObject, eventdata, h1, callback_name)
