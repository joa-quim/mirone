...
'Callback',{@wms_tool_uicallback,h1,'edit_res_CB'},...
'String','8',...
'Style','edit',...
'Tag','edit_res');
...
'BackgroundColor',[1 1 1],...
'Callback',{@wms_tool_uicallback,h1,'edit_date_CB'},...
'String','',...
'Style','edit',...
'TooltipString','Date in dd-mm-yyyy',...
'Tag','edit_date');

uicontrol('Parent',h1, 'Position',[11 50 201 21],...
'BackgroundColor',[1 1 1],...
'Callback',{@wms_tool_uicallback,h1,'popup_servers_CB'},...
'String','Daily planet (MODIS from JPL)',...
'Style','popupmenu',...
'TooltipString','Currently no other choice',...
'Value',1,...
'Tag','popup_servers');
...
'Callback',{@wms_tool_uicallback,h1,'check_proxy_CB'},...
'String','proxy?',...
'Style','checkbox',...
'TooltipString','Check if you are Proxy-dependent',...
'Tag','check_proxy');

uicontrol('Parent',h1, 'Position',[66 11 91 20],...
'BackgroundColor',[1 1 1],...
'Callback',{@wms_tool_uicallback,h1,'edit_proxy_CB'},...
'Enable','off',...
...
'BackgroundColor',[1 1 1],...
'Callback',{@wms_tool_uicallback,h1,'edit_port_CB'},...
'Enable','off',...
'HorizontalAlignment','left',...
'String','',...
'Style','edit',...
...
'Callback',{@wms_tool_uicallback,h1,'push_OK_CB'},...
'FontSize',10,...
'FontWeight','bold',...
'String','OK',...
'Tag','push_OK');
...
function wms_tool_uicallback(hObject, eventdata, h1, callback_name)
