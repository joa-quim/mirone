...
'Call',{@globalcmt_uiCB,h1,'edit_StartYear_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_StartMonth_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_StartDay_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_EndYear_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_EndMonth_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_EndDay_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_MagMwMin_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_MagMwMax_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_DepthMin_CB'},...
'Position',[54 14 47 21],...
'String','0',...
'Style','edit',...
'TooltipString','Depth in km',...
'Tag','edit_DepthMin');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_DepthMax_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_MagMsMin_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_MagMsMax_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_MagMbMin_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_MagMbMax_CB'},...
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_West_CB'},...
'Position',[120 88 81 22],...
'String','',...
'Style','edit',...
'TooltipString','West Longitude in the [-180; 180] interval. You may use dd:mm notation',...
'Tag','edit_West');
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_East_CB'},...
'Position',[240 88 81 22],...
'String','',...
'Style','edit',...
'TooltipString','East Longitude in the [-180; 180] interval. You may use dd:mm notation',...
'Tag','edit_East');

uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_South_CB'},...
'Position',[120 58 81 22],...
'String','',...
'Style','edit',...
'TooltipString','South Latitude. You may use dd:mm notation',...
'Tag','edit_South');
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Call',{@globalcmt_uiCB,h1,'edit_North_CB'},...
'Position',[240 58 81 22],...
'String','',...
'Style','edit',...
'TooltipString','North Latitude. You may use dd:mm notation',...
'Tag','edit_North');
...
uicontrol('Parent',h1,...
'Call',{@globalcmt_uiCB,h1,'push_OK_CB'},...
'Position',[256 8 66 23],...
'String','OK',...
'Tag','push_OK');


function globalcmt_uiCB(hObject, eventdata, h1, callback_name)
