...
'Call',{@grdfilter_mir_uicallback,h1,'edit_x_min_CB'},...
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'edit_x_max_CB'},...
'HorizontalAlignment','left',...
'Style','edit',...
'Tag','edit_x_max');
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'edit_y_min_CB'},...
'HorizontalAlignment','left',...
'Style','edit',...
'Tag','edit_y_min');
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'edit_y_max_CB'},...
'HorizontalAlignment','left',...
'Style','edit',...
'Tag','edit_y_max');
...
uicontrol('Parent',h1,...
'BackgroundColor',[1 1 1],...
'Callback',{@grdfilter_mir_uicallback,h1,'edit_x_inc_CB'},...
'HorizontalAlignment','left',...
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'edit_y_inc_CB'},...
'HorizontalAlignment','left',...
'Style','edit',...
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'edit_Ncols_CB'},...
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'edit_Nrows_CB'},...
'HorizontalAlignment','center',...
'Style','edit',...
...
'Call',{@grdfilter_mir_uicallback,h1,'pushbutton_Help_R_F_T_CB'},...
'FontWeight','bold',...
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'popup_FilterType_CB'},...
...
'Call',{@grdfilter_mir_uicallback,h1,'edit_FilterWidth_CB'},...
'HorizontalAlignment','center',...
'Style','edit',...
...
'Call',{@grdfilter_mir_uicallback,h1,'pushbutton_Help_FilterType_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
'String','?',...
...
'BackgroundColor',[1 1 1],...
'Call',{@grdfilter_mir_uicallback,h1,'popup_Option_D_CB'},...
'String',{  '0'; '1'; '2'; '3'; '4' },...
'Style','popupmenu',...
...
'Call',{@grdfilter_mir_uicallback,h1,'pushbutton_Help_Option_D_CB'},...
'FontWeight','bold',...
'ForegroundColor',[0 0 1],...
'String','?',...
...
uimenu('Parent',h1,...
'Call',{@grdfilter_mir_uicallback,h1,'Menu_Help_CB'},...
'Label','Help',...
'Tag','Menu_Help');

uicontrol('Parent',h1, 'Position',[295 6 105 21],...
'Call',{@grdfilter_mir_uicallback,h1,'push_Compute_CB'},...
'FontWeight','bold',...
'String','Compute',...
