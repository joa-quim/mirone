...
'Call',{@ground_motion_uiCB,h1,'radio_active_CB'},...
'FontName','Helvetica',...
...
'Call',{@ground_motion_uiCB,h1,'radio_stable_CB'},...
'FontName','Helvetica',...
...
'Call',{@ground_motion_uiCB,h1,'radio_guess_CB'},...
'FontName','Helvetica',...
'String','Let me guess',...
'Style','radiobutton',...
...
'BackgroundColor',[1 1 1],...
'Call',{@ground_motion_uiCB,h1,'edit_mag_CB'},...
'String','7',...
'Style','edit',...
...
'Call',{@ground_motion_uiCB,h1,'push_OK_CB'},...
'FontName','Helvetica',...
'FontSize',10,...
'FontWeight','bold',...
'String','OK',...
...
function ground_motion_uiCB(hObject, eventdata, h1, callback_name)
